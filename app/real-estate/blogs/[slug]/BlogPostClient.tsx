      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 pt-8">
        ...
        >
          {blog.coverImage ? (
            ...
            <div className="w-full h-full flex items-center justify-center px-8 text-center" style={{ background: "linear-gradient(135deg, rgba(184,137,42,0.15), rgba(0,102,162,0.15))" }}>
              <span className="font-bold leading-snug" style={{ fontSize: "clamp(1.2rem, 3vw, 1.8rem)", fontFamily: "var(--font-re)", color: "rgb(var(--flow-text-soft))" }}>
                {blog.title}
              </span>
            </div>
          )}
