    ...
    <div className="bg-flow-bg min-h-screen py-16">
      <div className="container mx-auto px-4">
        ...
        <div className="flex items-center text-sm text-flow-textSoft mb-8">
          ...
          <span className="mx-2">/</span>
          <span className="text-flow-textSoft">Digital Intelligence</span>
        </div>
          ...
          <div>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-start">
                ...
                <p className="text-flow-textSoft">Comprehensive analytics setup and tracking implementation</p>
              </div>
              <div className="flex items-start">
                <CheckCircle className="h-6 w-6 text-blue-600 mr-2 flex-shrink-0 mt-1" />
                <p className="text-flow-textSoft">Custom reporting dashboards tailored to your business goals</p>
              </div>
              <div className="flex items-start">
                <CheckCircle className="h-6 w-6 text-blue-600 mr-2 flex-shrink-0 mt-1" />
                <p className="text-flow-textSoft">Actionable insights to optimize marketing performance</p>
              </div>
              <div className="flex items-start">
                <CheckCircle className="h-6 w-6 text-blue-600 mr-2 flex-shrink-0 mt-1" />
                <p className="text-flow-textSoft">Competitive analysis to identify market opportunities</p>
              </div>
            </div>
        ...
        <div className="bg-flow-surface rounded-xl shadow-md p-8 mb-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="p-6 border border-flow-border rounded-lg hover:shadow-md transition-shadow">
