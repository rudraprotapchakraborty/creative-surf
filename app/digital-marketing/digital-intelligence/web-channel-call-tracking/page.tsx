    ...
    <div className="bg-flow-bg min-h-screen py-16">
      <div className="container mx-auto px-4">
        ...
        <div className="flex items-center text-sm text-flow-textSoft mb-8 flex-wrap">
          ...
          <span className="mx-2">/</span>
          <span className="text-flow-textSoft">Web Channel Call Tracking</span>
        </div>
          ...
          <div>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-start">
                ...
                <p className="text-flow-textSoft">Identify which marketing channels drive phone calls</p>
              </div>
              <div className="flex items-start">
                <CheckCircle className="h-6 w-6 text-blue-600 mr-2 flex-shrink-0 mt-1" />
                <p className="text-flow-textSoft">Measure the quality and conversion rate of phone leads</p>
              </div>
              <div className="flex items-start">
                <CheckCircle className="h-6 w-6 text-blue-600 mr-2 flex-shrink-0 mt-1" />
                <p className="text-flow-textSoft">Optimize marketing spend based on complete conversion data</p>
              </div>
              <div className="flex items-start">
                <CheckCircle className="h-6 w-6 text-blue-600 mr-2 flex-shrink-0 mt-1" />
                <p className="text-flow-textSoft">Integrate call data with your CRM and analytics platforms</p>
              </div>
            </div>
