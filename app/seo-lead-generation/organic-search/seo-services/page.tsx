    ...
    <div className="bg-flow-bg min-h-screen py-16">
      <div className="container mx-auto px-4">
        ...
        <div className="flex items-center text-sm text-flow-textSoft mb-8">
          ...
          <span className="mx-2">/</span>
          <span className="text-flow-textSoft">SEO Services</span>
        </div>
          ...
          <div>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-start">
                ...
                <p className="text-flow-textSoft">Customized SEO strategies tailored to your business goals</p>
              </div>
              <div className="flex items-start">
                <CheckCircle className="h-6 w-6 text-blue-600 mr-2 flex-shrink-0 mt-1" />
                <p className="text-flow-textSoft">Comprehensive keyword research and content optimization</p>
              </div>
              <div className="flex items-start">
                <CheckCircle className="h-6 w-6 text-blue-600 mr-2 flex-shrink-0 mt-1" />
                <p className="text-flow-textSoft">Technical SEO audits and implementation</p>
              </div>
              <div className="flex items-start">
                <CheckCircle className="h-6 w-6 text-blue-600 mr-2 flex-shrink-0 mt-1" />
                <p className="text-flow-textSoft">Regular reporting and performance analysis</p>
              </div>
            </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-flow-surface rounded-xl shadow-md p-6">
            ...
            <div>
              ...
              <ul className="space-y-2 mb-4">
                <li className="flex items-start">
                  ...
                  <p className="text-flow-textSoft">Increase organic traffic by 150% in 6 months</p>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-blue-600 mr-2 flex-shrink-0 mt-1" />
                  <p className="text-flow-textSoft">Improve keyword rankings for 50+ high-value terms</p>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-blue-600 mr-2 flex-shrink-0 mt-1" />
                  <p className="text-flow-textSoft">Generate 40% more qualified leads through the website</p>
                </li>
              </ul>
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-flow-surface rounded-xl shadow-md p-6 border-t-4 border-flow-border">
              <h3 className="text-2xl font-bold mb-2">Basic</h3>
              <p className="text-flow-textSoft mb-4">For small businesses just getting started with SEO</p>
              <div className="text-3xl font-bold mb-4">
                $1,500<span className="text-lg text-flow-textSoft">/mo</span>
              </div>
              <ul className="space-y-2 mb-6">
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-blue-600 mr-2 flex-shrink-0 mt-1" />
                  <p className="text-flow-textSoft">Keyword research (up to 20 keywords)</p>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-blue-600 mr-2 flex-shrink-0 mt-1" />
                  <p className="text-flow-textSoft">On-page optimization (up to 10 pages)</p>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-blue-600 mr-2 flex-shrink-0 mt-1" />
                  <p className="text-flow-textSoft">Monthly performance reporting</p>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-blue-600 mr-2 flex-shrink-0 mt-1" />
                  <p className="text-flow-textSoft">Basic technical SEO audit</p>
                </li>
              </ul>
            ...
            <div className="bg-flow-surface rounded-xl shadow-md p-6 border-t-4 border-blue-600 transform scale-105">
              ...
              <p className="text-flow-textSoft mb-4">For growing businesses seeking comprehensive SEO</p>
              <div className="text-3xl font-bold mb-4">
                $3,000<span className="text-lg text-flow-textSoft">/mo</span>
              </div>
              <ul className="space-y-2 mb-6">
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-blue-600 mr-2 flex-shrink-0 mt-1" />
                  <p className="text-flow-textSoft">Keyword research (up to 50 keywords)</p>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-blue-600 mr-2 flex-shrink-0 mt-1" />
                  <p className="text-flow-textSoft">On-page optimization (up to 25 pages)</p>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-blue-600 mr-2 flex-shrink-0 mt-1" />
                  <p className="text-flow-textSoft">Content creation (2 blog posts per month)</p>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-blue-600 mr-2 flex-shrink-0 mt-1" />
                  <p className="text-flow-textSoft">Comprehensive technical SEO audit</p>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-blue-600 mr-2 flex-shrink-0 mt-1" />
                  <p className="text-flow-textSoft">Competitor analysis</p>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-blue-600 mr-2 flex-shrink-0 mt-1" />
                  <p className="text-flow-textSoft">Bi-weekly performance reporting</p>
                </li>
              </ul>
            ...
            <div className="bg-flow-surface rounded-xl shadow-md p-6 border-t-4 border-flow-border">
              ...
              <p className="text-flow-textSoft mb-4">For large businesses with complex SEO needs</p>
              <div className="text-3xl font-bold mb-4">
                $5,000+<span className="text-lg text-flow-textSoft">/mo</span>
              </div>
              <ul className="space-y-2 mb-6">
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-blue-600 mr-2 flex-shrink-0 mt-1" />
                  <p className="text-flow-textSoft">Comprehensive keyword research</p>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-blue-600 mr-2 flex-shrink-0 mt-1" />
                  <p className="text-flow-textSoft">Full website optimization</p>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-blue-600 mr-2 flex-shrink-0 mt-1" />
                  <p className="text-flow-textSoft">Content creation (4+ blog posts per month)</p>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-blue-600 mr-2 flex-shrink-0 mt-1" />
                  <p className="text-flow-textSoft">Advanced technical SEO implementation</p>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-blue-600 mr-2 flex-shrink-0 mt-1" />
                  <p className="text-flow-textSoft">In-depth competitor analysis</p>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-blue-600 mr-2 flex-shrink-0 mt-1" />
                  <p className="text-flow-textSoft">Weekly performance reporting</p>
                </li>
                <li className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-blue-600 mr-2 flex-shrink-0 mt-1" />
                  <p className="text-flow-textSoft">Dedicated SEO manager</p>
                </li>
              </ul>
              <Button asChild className="w-full">
