      ...
      <section className="bg-flow-surface py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-flow-bg p-6 rounded-lg text-center">
              <p className="text-4xl font-bold text-blue-600 mb-2">46%</p>
              <p className="text-flow-textSoft">of all Google searches are looking for local information</p>
            </div>
            <div className="bg-flow-bg p-6 rounded-lg text-center">
              <p className="text-4xl font-bold text-blue-600 mb-2">88%</p>
              <p className="text-flow-textSoft">of consumers who search locally on mobile visit a store within 24 hours</p>
            </div>
            <div className="bg-flow-bg p-6 rounded-lg text-center">
              <p className="text-4xl font-bold text-blue-600 mb-2">78%</p>
              <p className="text-flow-textSoft">of local mobile searches result in offline purchases</p>
            </div>
          </div>
        </div>
      </section>
                ...
                <ul className="space-y-4">
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-flow-textSoft">Local searchers have high intent and are more likely to convert.</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-6 w-6 text-green-500 flex-shrink-0 mt-1" />
      ...
      <section className="py-16 bg-flow-surface">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-flow-bg p-6 rounded-lg">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="border rounded-lg overflow-hidden">
              <div className="bg-flow-bg p-6 text-center">
                <h3 className="text-xl font-semibold">Basic</h3>
                <p className="text-3xl font-bold mt-2">
                  $499<span className="text-sm font-normal text-flow-textSoft">/mo</span>
                </p>
                <p className="text-flow-textSoft mt-2">For small local businesses</p>
              </div>
              <div className="p-6">
            ...
            <div className="border rounded-lg overflow-hidden shadow-lg relative">
              ...
              <div className="bg-blue-50 p-6 text-center">
                ...
                <p className="text-3xl font-bold mt-2">
                  $899<span className="text-sm font-normal text-flow-textSoft">/mo</span>
                </p>
                <p className="text-flow-textSoft mt-2">For growing local businesses</p>
              </div>
              <div className="p-6">
                <ul className="space-y-3">
                  <li className="flex items-center gap-2">
            ...
            <div className="border rounded-lg overflow-hidden">
              <div className="bg-flow-bg p-6 text-center">
                ...
                <p className="text-3xl font-bold mt-2">
                  $1,499<span className="text-sm font-normal text-flow-textSoft">/mo</span>
                </p>
                <p className="text-flow-textSoft mt-2">For multi-location businesses</p>
              </div>
              <div className="p-6">
                <ul className="space-y-3">
                  <li className="flex items-center gap-2">
      ...
      <section className="py-16 bg-flow-surface">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="bg-flow-bg rounded-lg p-6">
