...
const SERVICE_HREFS = [
  ...
  "/seo-lead-generation/organic-search/enterprise-seo",
  "/seo-lead-generation/organic-search/digital-marketing",
  "/seo-lead-generation/organic-search/local-seo",
  "/seo-lead-generation/organic-search/google-local-services",
  "/seo-lead-generation/organic-search/seo-audits",
    ...
    <div className="bg-flow-bg min-h-screen py-16">
      <div className="container mx-auto px-4">
        ...
        <div className="flex items-center text-sm text-flow-textSoft mb-8">
          ...
          <span className="mx-2">/</span>
          <span className="text-flow-textSoft">{t("organicSearch.breadcrumbCurrent")}</span>
        </div>

        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          <div>
            <h1 className="text-4xl md:text-5xl font-bold mb-6">{t("organicSearch.title")}</h1>
            <p className="text-xl text-flow-textSoft mb-6">{t("organicSearch.intro")}</p>
            <div className="space-y-4 mb-8">
              {t.list("organicSearch.highlights").map((highlight) => (
        ...
        {/* Services Grid */}
        <div className="mb-16">
          <h2 className="text-3xl font-bold mb-8 text-center">{t("organicSearch.servicesTitle")}</h2>
        ...
        <div className="bg-blue-600 text-white rounded-xl p-8 text-center">
          <h2 className="text-3xl font-bold mb-4">{t("organicSearch.ctaTitle")}</h2>
          <p className="text-xl mb-6 max-w-2xl mx-auto">{t("organicSearch.ctaBody")}</p>
