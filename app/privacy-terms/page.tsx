    ...
    <div className="bg-flow-bg min-h-screen py-16">
      <div className="container mx-auto px-4">
        ...
        <div className="flex items-center text-sm text-flow-textSoft mb-8">
          ...
          <span className="text-flow-textSoft font-medium">Privacy & Terms of Use</span>
        </div>

        <div className="bg-flow-surface rounded-xl shadow-md p-8 md:p-12">
          <h1 className="text-3xl md:text-4xl font-bold mb-8 text-flow-text">Privacy Policy & Terms of Use</h1>
          <p className="text-flow-textSoft mb-8">Last Updated: March 12, 2025</p>

          <div className="prose max-w-none text-flow-textSoft">
            <h2 className="text-2xl font-semibold text-flow-text mt-12 mb-4">1. Introduction</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold text-flow-text mt-12 mb-4">2. Information We Collect</h2>
            <h3 className="text-xl font-medium text-flow-text mt-6 mb-3">2.1 Personal Information</h3>
            ...
            <h3 className="text-xl font-medium text-flow-text mt-6 mb-3">2.2 Automatically Collected Information</h3>
            <p>
            ...
            <h2 className="text-2xl font-semibold text-flow-text mt-12 mb-4">3. How We Use Your Information</h2>
            ...
            <h2 className="text-2xl font-semibold text-flow-text mt-12 mb-4">4. Cookies and Similar Technologies</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold text-flow-text mt-12 mb-4">5. Data Sharing and Disclosure</h2>
            ...
            <h2 className="text-2xl font-semibold text-flow-text mt-12 mb-4">6. Data Security</h2>
            <p>
            ...
            <h2 className="text-2xl font-semibold text-flow-text mt-12 mb-4">7. Your Data Protection Rights</h2>
            ...
            <div className="border-t border-flow-border my-12 pt-12">
              <h1 className="text-3xl font-bold mb-8 text-flow-text">Terms of Use</h1>

              <h2 className="text-2xl font-semibold text-flow-text mt-12 mb-4">1. Acceptance of Terms</h2>
              <p>
              ...
              <h2 className="text-2xl font-semibold text-flow-text mt-12 mb-4">2. Use License</h2>
              <p>
              ...
              <h2 className="text-2xl font-semibold text-flow-text mt-12 mb-4">3. Disclaimer</h2>
              <p>
              ...
              <h2 className="text-2xl font-semibold text-flow-text mt-12 mb-4">4. Limitations</h2>
              <p>
              ...
              <h2 className="text-2xl font-semibold text-flow-text mt-12 mb-4">5. Accuracy of Materials</h2>
              <p>
              ...
              <h2 className="text-2xl font-semibold text-flow-text mt-12 mb-4">6. Links</h2>
              <p>
              ...
              <h2 className="text-2xl font-semibold text-flow-text mt-12 mb-4">7. Modifications</h2>
              <p>
              ...
              <h2 className="text-2xl font-semibold text-flow-text mt-12 mb-4">8. Governing Law</h2>
              <p>
            ...
            <h2 className="text-2xl font-semibold text-flow-text mt-12 mb-4">Contact Us</h2>
            <p>If you have any questions about this Privacy Policy or Terms of Use, please contact us at:</p>
            <div className="bg-flow-bg p-6 rounded-lg mt-4">
              <p>
