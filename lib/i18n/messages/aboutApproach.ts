...
export const aboutApproachMessages = defineMessages({
  en: {
    metaTitle: "Our Approach | Creative Surf",
    metaDescription:
      "Discover the proven methodology Creative Surf uses to deliver measurable results: discovery, strategy, execution and continuous optimization.",
    hero: {
      title: "Our Approach",
    ...
    philosophy: {
      ...
      intro:
        "At Creative Surf, we believe in a data-driven, client-focused approach that delivers measurable results. Our methodology combines strategic thinking, creative excellence, and technical expertise.",
      cards: [
        {
          title: "Strategic Focus",
          body:
            "We begin with understanding your business goals and target audience to create strategies that align with your objectives.",
        },
        {
          title: "Data-Driven Decisions",
          body:
            "We leverage analytics and market research to inform our strategies and continuously optimize for better performance.",
        },
        {
          title: "Creative Innovation",
          body:
            "We combine creativity with technology to develop innovative solutions that help your brand stand out in a crowded market.",
        },
      ],
    },
    process: {
      title: "Our Process",
      intro: "A systematic approach that ensures consistent quality and results",
      expectLabel: "What to expect:",
      steps: [
        {
          title: "Discovery & Analysis",
          body:
            "We begin by understanding your business, goals, target audience, and competitive landscape. Our team conducts thorough research and analysis to identify opportunities and challenges.",
          points: [
        ...
        },
        {
          ...
          body:
            "Based on our findings, we develop a customized strategy that aligns with your business objectives. We establish clear KPIs and create a roadmap for implementation.",
          points: [
        ...
        },
        {
          ...
          body:
            "Our expert team executes the strategy with precision and attention to detail. We leverage the latest tools and technologies to deliver high-quality results.",
          points: [
            "Skilled execution by specialists",
        ...
        },
        {
          ...
          body:
            "We continuously monitor performance, analyze results, and make data-driven optimizations to improve outcomes and maximize ROI.",
          points: [
    ...
    methodology: {
      ...
      intro: "The core principles that guide our work and ensure exceptional results",
      cards: [
        {
          title: "Client Partnership",
          body:
            "We view ourselves as an extension of your team, working collaboratively to achieve your goals. Our transparent communication and regular updates ensure you're always informed and involved.",
        },
        {
          title: "Agile Execution",
          body:
            "Our agile approach allows us to adapt quickly to changing market conditions and business needs. We iterate rapidly, test continuously, and optimize for maximum impact.",
        },
        {
          title: "Results-Focused",
          body:
            "We're obsessed with delivering measurable results that impact your bottom line. Every strategy and tactic is designed with clear objectives and KPIs in mind.",
        },
        {
          title: "Continuous Innovation",
          body:
            "We stay at the forefront of industry trends and technologies to bring innovative solutions that give your business a competitive edge in the market.",
        },
      ],
    },
    caseStudies: {
      title: "Our Approach in Action",
      intro: "See how our methodology has delivered exceptional results for our clients",
      readMore: "Read Case Study",
      items: [
        {
          category: "E-commerce",
          title: "300% Revenue Growth",
          body: "How we helped an e-commerce brand triple their revenue through strategic digital marketing.",
          imageAlt: "E-commerce Growth Case Study",
        },
        {
          category: "B2B",
          title: "10x Lead Generation",
          body: "How our approach helped a B2B company increase qualified leads by 10x in 6 months.",
          imageAlt: "B2B Lead Generation Case Study",
        },
        {
          category: "Brand Transformation",
          title: "Brand Relaunch Success",
          body: "How we helped a legacy brand transform digitally and capture a new market segment.",
          imageAlt: "Brand Transformation Case Study",
        },
      ],
    },
    cta: {
      title: "Ready to Experience Our Approach?",
      body: "Let's discuss how our proven methodology can help your business achieve exceptional results.",
      contact: "Contact Us",
  ...
  bn: {
    metaTitle: "আমাদের দৃষ্টিভঙ্গি | Creative Surf",
    metaDescription:
      "মাপযোগ্য ফলাফল দিতে Creative Surf যে পরীক্ষিত পদ্ধতি অনুসরণ করে তা জেনে নিন: অনুসন্ধান, কৌশল, বাস্তবায়ন আর নিরন্তর উন্নয়ন।",
    hero: {
      title: "আমাদের দৃষ্টিভঙ্গি",
      subtitle: "পরীক্ষিত পদ্ধতির মাধ্যমে আমরা যেভাবে অসাধারণ ফল এনে দিই",
    },
    philosophy: {
      title: "আমাদের দর্শন",
      intro:
        "Creative Surf-এ আমরা এমন একটি ডেটাভিত্তিক, ক্লায়েন্ট-কেন্দ্রিক পদ্ধতিতে বিশ্বাস করি যা মাপযোগ্য ফল এনে দেয়। আমাদের পদ্ধতিতে মিশে থাকে কৌশলী চিন্তা, সৃজনশীল উৎকর্ষ আর কারিগরি দক্ষতা।",
      cards: [
        {
          title: "কৌশলে মনোযোগ",
          body:
            "আপনার ব্যবসায়িক লক্ষ্য আর দর্শক বুঝে নেওয়া দিয়ে শুরু করি, যাতে কৌশলটি আপনার উদ্দেশ্যের সাথে মেলে।",
        },
        {
          title: "ডেটাভিত্তিক সিদ্ধান্ত",
          body:
            "অ্যানালিটিক্স আর বাজার গবেষণা কাজে লাগিয়ে আমরা কৌশল সাজাই এবং আরও ভালো ফলের জন্য নিরন্তর উন্নত করি।",
        },
        {
          title: "সৃজনশীল উদ্ভাবন",
          body:
            "সৃজনশীলতা আর প্রযুক্তি মিলিয়ে আমরা এমন উদ্ভাবনী সমাধান তৈরি করি, যা ভিড়ের বাজারে আপনার ব্র্যান্ডকে আলাদা করে তোলে।",
        },
      ],
    },
    process: {
      title: "আমাদের কাজের ধাপ",
      intro: "একটি সুসংগঠিত পদ্ধতি, যা ধারাবাহিক মান আর ফল নিশ্চিত করে",
      expectLabel: "যা আশা করতে পারেন:",
      steps: [
        {
          title: "অনুসন্ধান ও বিশ্লেষণ",
          body:
            "শুরুতেই আমরা আপনার ব্যবসা, লক্ষ্য, দর্শক আর প্রতিযোগিতার চিত্র বুঝে নিই। আমাদের টিম গভীর গবেষণা ও বিশ্লেষণ করে সুযোগ আর চ্যালেঞ্জ খুঁজে বের করে।",
          points: [
            "পূর্ণাঙ্গ ব্যবসায়িক বিশ্লেষণ",
            "প্রতিযোগিতার চিত্র মূল্যায়ন",
            "লক্ষ্য দর্শক নিয়ে গবেষণা",
          ],
        },
        {
          title: "কৌশল তৈরি",
          body:
            "যা জানলাম তার ভিত্তিতে আমরা আপনার ব্যবসায়িক লক্ষ্যের সাথে মেলে এমন কৌশল সাজাই। স্পষ্ট কেপিআই ঠিক করি আর বাস্তবায়নের রোডম্যাপ বানাই।",
          points: [
            "আপনার জন্য সাজানো কৌশলগত পরিকল্পনা",
            "স্পষ্ট কেপিআই আর সাফল্যের মাপকাঠি",
            "সম্পদ বণ্টন ও সময়সূচি",
          ],
        },
        {
          title: "বাস্তবায়ন",
          body:
            "আমাদের দক্ষ টিম নিখুঁতভাবে আর খুঁটিনাটির যত্ন নিয়ে কৌশলটি বাস্তবায়ন করে। উঁচু মানের ফল দিতে আমরা সর্বাধুনিক টুল ও প্রযুক্তি কাজে লাগাই।",
          points: [
            "বিশেষজ্ঞদের হাতে দক্ষ বাস্তবায়ন",
            "নিয়মিত অগ্রগতির খবর",
            "প্রতিটি ধাপে মান যাচাই",
          ],
        },
        {
          title: "পরিমাপ ও উন্নয়ন",
          body:
            "আমরা নিয়মিত পারফরম্যান্স দেখি, ফল বিশ্লেষণ করি আর ডেটার ভিত্তিতে উন্নতি আনি, যাতে ফলাফল ভালো হয় আর আরওআই সর্বোচ্চ হয়।",
          points: [
            "পূর্ণাঙ্গ পারফরম্যান্স রিপোর্ট",
            "ডেটাভিত্তিক উন্নয়নের পরামর্শ",
            "নিরন্তর উন্নতির চক্র",
          ],
        },
      ],
    },
    methodology: {
      title: "আমাদের পদ্ধতি",
      intro: "যেসব মূল নীতি আমাদের কাজ পরিচালনা করে আর অসাধারণ ফল নিশ্চিত করে",
      cards: [
        {
          title: "ক্লায়েন্টের সঙ্গী হয়ে",
          body:
            "আমরা নিজেদের আপনার টিমেরই একটি অংশ মনে করি আর একসাথে আপনার লক্ষ্যে পৌঁছাতে কাজ করি। স্বচ্ছ যোগাযোগ আর নিয়মিত আপডেটের কারণে আপনি সবসময় সব জানেন আর যুক্ত থাকেন।",
        },
        {
          title: "চটপটে বাস্তবায়ন",
          body:
            "আমাদের অ্যাজাইল পদ্ধতিতে বদলে যাওয়া বাজার আর ব্যবসার চাহিদার সাথে দ্রুত মানিয়ে নেওয়া যায়। আমরা দ্রুত পরিবর্তন আনি, নিয়মিত পরীক্ষা করি আর সর্বোচ্চ ফলের জন্য সাজিয়ে নিই।",
        },
        {
          title: "ফলাফলকেন্দ্রিক",
          body:
            "আপনার আয়ে প্রভাব ফেলে এমন মাপযোগ্য ফল দিতে আমরা মরিয়া। প্রতিটি কৌশল আর পদক্ষেপ সাজানো হয় স্পষ্ট লক্ষ্য আর কেপিআই মাথায় রেখে।",
        },
        {
          title: "নিরন্তর উদ্ভাবন",
          body:
            "আমরা ইন্ডাস্ট্রির প্রবণতা আর প্রযুক্তিতে সবার আগে থাকি, যাতে এমন উদ্ভাবনী সমাধান দিতে পারি যা বাজারে আপনার ব্যবসাকে এগিয়ে রাখে।",
        },
      ],
    },
    caseStudies: {
      title: "কাজে আমাদের দৃষ্টিভঙ্গি",
      intro: "আমাদের পদ্ধতি ক্লায়েন্টদের জন্য কেমন অসাধারণ ফল এনেছে দেখুন",
      readMore: "কেস স্টাডি পড়ুন",
      items: [
        {
          category: "ই-কমার্স",
          title: "৩০০% আয় বৃদ্ধি",
          body: "কৌশলী ডিজিটাল মার্কেটিংয়ের মাধ্যমে একটি ই-কমার্স ব্র্যান্ডের আয় আমরা যেভাবে তিন গুণ করেছি।",
          imageAlt: "ই-কমার্স প্রবৃদ্ধির কেস স্টাডি",
        },
        {
          category: "বি২বি",
          title: "১০ গুণ লিড",
          body: "আমাদের পদ্ধতিতে একটি বি২বি প্রতিষ্ঠান ৬ মাসে কীভাবে ১০ গুণ যোগ্য লিড পেয়েছে।",
          imageAlt: "বি২বি লিড জেনারেশনের কেস স্টাডি",
        },
        {
          category: "ব্র্যান্ড রূপান্তর",
          title: "সফল ব্র্যান্ড পুনঃপ্রবর্তন",
          body: "একটি পুরনো ব্র্যান্ডকে ডিজিটালি বদলে নতুন বাজার ধরতে আমরা যেভাবে সাহায্য করেছি।",
          imageAlt: "ব্র্যান্ড রূপান্তরের কেস স্টাডি",
        },
      ],
    },
    cta: {
      title: "আমাদের দৃষ্টিভঙ্গি পরখ করতে প্রস্তুত?",
      body: "আমাদের পরীক্ষিত পদ্ধতি কীভাবে আপনার ব্যবসাকে অসাধারণ ফল এনে দিতে পারে, চলুন আলোচনা করি।",
      contact: "যোগাযোগ করুন",
      proposal: "প্রস্তাব নিন",
    },
  },
});
