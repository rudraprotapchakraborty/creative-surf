...
export const localSeoMessages = defineMessages({
  en: {
    metaTitle: "Local SEO Services",
    metaDescription:
      "Dominate local search results, attract nearby customers, and grow your business with our data-driven local SEO strategies.",
    hero: {
      title: "Local SEO Services That Drive Foot Traffic & Revenue",
      subtitle:
        "Dominate local search results, attract nearby customers, and grow your business with our data-driven local SEO strategies.",
      ctaPrimary: "Get a Free Consultation",
      ctaSecondary: "View Pricing",
      imageAlt: "Local SEO illustration showing a map with business locations",
    },
    stats: [
      { value: "46%", label: "of all Google searches are looking for local information" },
      { value: "88%", label: "of consumers who search locally on mobile visit a store within 24 hours" },
      { value: "78%", label: "of local mobile searches result in offline purchases" },
    ],
    what: {
      title: "What is Local SEO?",
      body:
        "Local SEO is the process of optimizing your online presence to attract more business from relevant local searches. These searches take place on Google and other search engines.",
      whyTitle: "Why Local SEO Matters",
      imageAlt: "Local search results on Google showing map and business listings",
      reasons: [
        {
          title: "Increased Visibility in Local Searches",
          body: 'Appear in the "Local Pack," Google Maps, and local organic results.',
        },
        {
          title: "Higher Conversion Rates",
          body: "Local searchers have high intent and are more likely to convert.",
        },
        {
          title: "Mobile Search Dominance",
          body: 'Capture the growing number of "near me" searches on mobile devices.',
        },
        {
          title: "Competitive Advantage",
          body: "Stand out from local competitors who aren't optimizing for local search.",
        },
      ],
    },
    services: {
      title: "Our Local SEO Services",
      intro: "We offer comprehensive local SEO solutions tailored to your business needs and goals.",
      items: [
        {
        ...
        },
        {
          ...
          body: "We help you generate, monitor, and respond to customer reviews across all platforms.",
          points: [
        ...
        },
        {
          ...
          body: "We identify the most valuable local keywords to target for your business and location.",
          points: [
        ...
        },
        {
          ...
          body: "We build high-quality local backlinks to boost your site's authority in your service areas.",
          points: [
        ...
        },
        {
          ...
          body: "We create location-specific content that resonates with your local audience and search engines.",
          points: [
        ...
        },
        {
          ...
          body: "We ensure your business information is consistent across all online directories and platforms.",
          points: [
    ...
    process: {
      ...
      intro: "We follow a proven, data-driven approach to boost your local search presence.",
      steps: [
        {
          title: "Local SEO Audit",
          body: "We analyze your current local presence, identify opportunities, and develop a tailored strategy.",
        },
        {
          title: "On-Page Optimization",
          body: "We optimize your website with local keywords, schema markup, and location-specific content.",
        },
        {
          title: "Google Business Profile Optimization",
          body: "We fully optimize your GBP listing with accurate information, photos, posts, and Q&A management.",
        },
        {
          title: "Citation Building",
          body: "We create and manage consistent business listings across all relevant directories and platforms.",
        },
        {
          title: "Ongoing Optimization & Reporting",
          body: "We continuously monitor performance, make adjustments, and provide detailed monthly reports.",
        },
      ],
    },
    pricing: {
      title: "Local SEO Pricing",
      intro: "Transparent pricing for our local SEO services. Choose the plan that fits your business needs.",
      perMonth: "/mo",
      ...
      tiers: [
        {
          name: "Basic",
          price: "$499",
          audience: "For small local businesses",
          features: [
        ...
        },
        {
          ...
          features: [
            ...
            "Local content creation (2 pieces/mo)",
        ...
        },
        {
          ...
          features: [
            ...
            "Local content creation (4 pieces/mo)",
            "Local link building (10 links/mo)",
    ...
    caseStudies: {
      ...
      intro: "See how we've helped local businesses dominate their markets.",
      readMore: "Read Case Study",
      items: [
        {
          category: "Restaurant",
          title: "147% Increase in Local Search Visibility",
          body:
            "We helped a local restaurant chain increase their Google Business Profile views by 147% and drive a 63% increase in direction requests.",
          imageAlt: "Restaurant case study",
        },
        {
          category: "Dental Practice",
          title: "83% More New Patients from Local Search",
          body:
            "Our local SEO strategy helped a dental practice rank in the top 3 for all major local keywords, resulting in 83% more new patients.",
          imageAlt: "Dental practice case study",
        },
        {
          category: "Home Services",
          title: "215% ROI from Local SEO Campaign",
          body:
            "We helped a plumbing company dominate local search in 5 cities, resulting in a 215% ROI from their local SEO investment.",
          imageAlt: "Home services case study",
        },
      ],
    },
    faq: {
      title: "Frequently Asked Questions",
      intro: "Get answers to common questions about our local SEO services.",
      items: [
        {
          question: "How long does it take to see results from local SEO?",
          answer:
            "Most clients begin to see improvements in local rankings within 30-60 days, with significant results typically appearing within 3-6 months. The timeline depends on your starting point, competition level, and the aggressiveness of your strategy.",
        },
        {
          question: "Do I need a separate local SEO strategy for each location?",
          answer:
            "Yes, each location requires its own optimization strategy. This includes unique Google Business Profiles, location-specific content, and targeted citation building for each service area. Our multi-location packages are designed to efficiently manage this process.",
        },
        {
          question: "How do you measure the success of local SEO campaigns?",
          answer:
            "We track multiple KPIs including local pack rankings, organic rankings for local keywords, Google Business Profile metrics (views, clicks, calls, direction requests), website traffic from local searches, and most importantly, conversions from local search channels.",
        },
        {
          question: "What makes your local SEO services different?",
          answer:
            "Our approach combines data-driven strategies, hyper-local content creation, and advanced technical optimization. We also emphasize conversion rate optimization for local landing pages to ensure you're not just getting more visibility, but more customers.",
        },
      ],
    },
    cta: {
      title: "Ready to Dominate Local Search?",
      body: "Get a free local SEO audit and discover how we can help your business attract more local customers.",
  ...
  bn: {
    metaTitle: "লোকাল এসইও সেবা",
    metaDescription:
      "আমাদের ডেটাভিত্তিক লোকাল এসইও কৌশলে স্থানীয় সার্চে এগিয়ে থাকুন, কাছের ক্রেতাদের টানুন আর ব্যবসা বাড়ান।",
    hero: {
      title: "এমন লোকাল এসইও, যা দোকানে ভিড় আর আয় দুটোই আনে",
      subtitle:
        "আমাদের ডেটাভিত্তিক লোকাল এসইও কৌশলে স্থানীয় সার্চে এগিয়ে থাকুন, কাছের ক্রেতাদের টানুন আর ব্যবসা বাড়ান।",
      ctaPrimary: "বিনামূল্যে পরামর্শ নিন",
      ctaSecondary: "মূল্য দেখুন",
      imageAlt: "ব্যবসার অবস্থানসহ মানচিত্র দেখানো লোকাল এসইও চিত্র",
    },
    stats: [
      { value: "৪৬%", label: "Google-এর সব সার্চের এই অংশ স্থানীয় তথ্য খোঁজে" },
      { value: "৮৮%", label: "মোবাইলে স্থানীয় সার্চ করা ক্রেতাদের এই অংশ ২৪ ঘণ্টার মধ্যে দোকানে যান" },
      { value: "৭৮%", label: "মোবাইলে করা স্থানীয় সার্চের এই অংশ অফলাইনে কেনাকাটায় গড়ায়" },
    ],
    what: {
      title: "লোকাল এসইও কী?",
      body:
        "লোকাল এসইও হলো আপনার অনলাইন উপস্থিতি এমনভাবে সাজানো, যাতে প্রাসঙ্গিক স্থানীয় সার্চ থেকে বেশি ব্যবসা আসে। এই সার্চগুলো Google ও অন্যান্য সার্চ ইঞ্জিনে হয়।",
      whyTitle: "লোকাল এসইও কেন জরুরি",
      imageAlt: "মানচিত্র ও ব্যবসার তালিকাসহ Google-এর স্থানীয় সার্চ ফলাফল",
      reasons: [
        {
          title: "স্থানীয় সার্চে বেশি দৃশ্যমানতা",
          body: '"লোকাল প্যাক", Google Maps আর স্থানীয় অর্গানিক ফলাফলে জায়গা করে নিন।',
        },
        {
          title: "বেশি কনভার্শন হার",
          body: "স্থানীয় সার্চ করা মানুষদের আগ্রহ বেশি থাকে, তাই তাঁরা ক্রেতা হন বেশি।",
        },
        {
          title: "মোবাইল সার্চের প্রাধান্য",
          body: 'মোবাইলে বেড়ে চলা "কাছাকাছি" সার্চগুলো ধরে ফেলুন।',
        },
        {
          title: "প্রতিযোগিতায় এগিয়ে",
          body: "যেসব স্থানীয় প্রতিযোগী লোকাল সার্চের জন্য সাজাচ্ছে না, তাদের চেয়ে আলাদা হয়ে উঠুন।",
        },
      ],
    },
    services: {
      title: "আমাদের লোকাল এসইও সেবাসমূহ",
      intro: "আপনার ব্যবসার চাহিদা ও লক্ষ্য অনুযায়ী সাজানো পূর্ণাঙ্গ লোকাল এসইও সমাধান আমরা দিই।",
      items: [
        {
          title: "Google Business Profile সাজানো",
          body:
            "স্থানীয় সার্চ ফলাফল আর Google Maps-এ দৃশ্যমানতা বাড়াতে আমরা আপনার Google Business Profile সাজিয়ে দিই।",
          points: [
            "প্রোফাইল যাচাই ও সেটআপ",
            "ক্যাটাগরি সাজানো",
            "ছবি ও ভিডিও ব্যবস্থাপনা",
            "প্রশ্নোত্তর পর্যবেক্ষণ ও ব্যবস্থাপনা",
          ],
        },
        {
          title: "রিভিউ ব্যবস্থাপনা",
          body: "সব প্ল্যাটফর্মে ক্রেতাদের রিভিউ আনতে, পর্যবেক্ষণ করতে আর জবাব দিতে আমরা সাহায্য করি।",
          points: [
            "রিভিউ আনার কৌশল",
            "রিভিউ পর্যবেক্ষণের টুল",
            "জবাবের টেমপ্লেট ও দিকনির্দেশনা",
            "সুনাম ব্যবস্থাপনা",
          ],
        },
        {
          title: "স্থানীয় কি-ওয়ার্ড গবেষণা",
          body: "আপনার ব্যবসা ও এলাকার জন্য সবচেয়ে মূল্যবান স্থানীয় কি-ওয়ার্ডগুলো আমরা খুঁজে বের করি।",
          points: [
            "এলাকাভিত্তিক কি-ওয়ার্ড গবেষণা",
            "প্রতিযোগীদের কি-ওয়ার্ড বিশ্লেষণ",
            '"কাছাকাছি" সার্চের জন্য সাজানো',
            "স্থানীয় চাহিদার মানচিত্র",
          ],
        },
        {
          title: "স্থানীয় লিংক বিল্ডিং",
          body: "আপনার সেবা এলাকায় সাইটের কর্তৃত্ব বাড়াতে আমরা মানসম্মত স্থানীয় ব্যাকলিংক তৈরি করি।",
          points: [
            "স্থানীয় ব্যবসার ডিরেক্টরি",
            "চেম্বার অব কমার্সে তালিকাভুক্তি",
            "স্থানীয় স্পনসরশিপের সুযোগ",
            "সমাজে অংশগ্রহণ",
          ],
        },
        {
          title: "স্থানীয় কনটেন্ট কৌশল",
          body: "আমরা এলাকাভিত্তিক কনটেন্ট বানাই, যা আপনার স্থানীয় দর্শক আর সার্চ ইঞ্জিন দুটোরই মন ছোঁয়।",
          points: [
            "এলাকাভিত্তিক পেজ তৈরি",
            "স্থানীয় ব্লগ কনটেন্ট",
            "এলাকাভিত্তিক সেবা পেজ",
            "স্থানীয় আয়োজনের কভারেজ",
          ],
        },
        {
          title: "সাইটেশন তৈরি ও ব্যবস্থাপনা",
          body: "সব অনলাইন ডিরেক্টরি আর প্ল্যাটফর্মে আপনার ব্যবসার তথ্য যাতে একরকম থাকে তা আমরা নিশ্চিত করি।",
          points: [
            "নাম-ঠিকানা-ফোনের সামঞ্জস্য যাচাই",
            "সাইটেশন পরিষ্কার করা",
            "নতুন সাইটেশন তৈরি",
            "নিয়মিত সাইটেশন পর্যবেক্ষণ",
          ],
        },
      ],
    },
    process: {
      title: "আমাদের লোকাল এসইও ধাপ",
      intro: "স্থানীয় সার্চে আপনার উপস্থিতি বাড়াতে আমরা একটি পরীক্ষিত, ডেটাভিত্তিক পদ্ধতি অনুসরণ করি।",
      steps: [
        {
          title: "লোকাল এসইও অডিট",
          body: "আপনার বর্তমান স্থানীয় উপস্থিতি বিশ্লেষণ করে সুযোগ চিহ্নিত করি আর আপনার জন্য কৌশল সাজাই।",
        },
        {
          title: "অন-পেজ অপ্টিমাইজেশন",
          body: "স্থানীয় কি-ওয়ার্ড, স্কিমা মার্কআপ আর এলাকাভিত্তিক কনটেন্ট দিয়ে আপনার ওয়েবসাইট সাজিয়ে দিই।",
        },
        {
          title: "Google Business Profile সাজানো",
          body: "সঠিক তথ্য, ছবি, পোস্ট আর প্রশ্নোত্তর ব্যবস্থাপনা দিয়ে আপনার GBP তালিকা পুরোপুরি সাজিয়ে দিই।",
        },
        {
          title: "সাইটেশন তৈরি",
          body: "সংশ্লিষ্ট সব ডিরেক্টরি আর প্ল্যাটফর্মে একরকম ব্যবসায়িক তালিকা তৈরি ও রক্ষণাবেক্ষণ করি।",
        },
        {
          title: "নিয়মিত উন্নয়ন ও রিপোর্ট",
          body: "আমরা নিয়মিত পারফরম্যান্স দেখি, প্রয়োজনীয় বদল আনি আর বিস্তারিত মাসিক রিপোর্ট দিই।",
        },
      ],
    },
    pricing: {
      title: "লোকাল এসইওর মূল্য",
      intro: "আমাদের লোকাল এসইও সেবার স্বচ্ছ মূল্য। আপনার ব্যবসার সাথে মানানসই প্যাকেজটি বেছে নিন।",
      perMonth: "/মাস",
      ...
      tiers: [
        {
          name: "বেসিক",
          price: "$499",
          audience: "ছোট স্থানীয় ব্যবসার জন্য",
          features: [
            "Google Business Profile সাজানো",
            "স্থানীয় কি-ওয়ার্ড গবেষণা",
            "২০টি স্থানীয় সাইটেশন",
            "প্রাথমিক রিভিউ ব্যবস্থাপনা",
            "মাসিক রিপোর্ট",
          ],
        },
        {
          name: "প্রফেশনাল",
          price: "$899",
          audience: "বাড়ন্ত স্থানীয় ব্যবসার জন্য",
          features: [
            "বেসিকের সবকিছু",
            "৫০টি স্থানীয় সাইটেশন",
            "উন্নত রিভিউ ব্যবস্থাপনা",
            "স্থানীয় কনটেন্ট তৈরি (মাসে ২টি)",
            "স্থানীয় লিংক বিল্ডিং (মাসে ৫টি)",
            "পাক্ষিক রিপোর্ট",
          ],
        },
        {
          name: "এন্টারপ্রাইজ",
          price: "$1,499",
          audience: "একাধিক শাখার ব্যবসার জন্য",
          features: [
            "প্রফেশনালের সবকিছু",
            "১০০+ স্থানীয় সাইটেশন",
            "একাধিক শাখার ব্যবস্থাপনা",
            "স্থানীয় কনটেন্ট তৈরি (মাসে ৪টি)",
            "স্থানীয় লিংক বিল্ডিং (মাসে ১০টি)",
            "সাপ্তাহিক রিপোর্ট ও কৌশল আলোচনা",
          ],
        },
      ],
    },
    caseStudies: {
      title: "লোকাল এসইও সাফল্যের গল্প",
      intro: "স্থানীয় ব্যবসাগুলোকে নিজেদের বাজারে এগিয়ে দিতে আমরা কীভাবে সাহায্য করেছি দেখুন।",
      readMore: "কেস স্টাডি পড়ুন",
      items: [
        {
          category: "রেস্তোরাঁ",
          title: "স্থানীয় সার্চে দৃশ্যমানতা ১৪৭% বৃদ্ধি",
          body:
            "একটি স্থানীয় রেস্তোরাঁ চেইনের Google Business Profile দেখার সংখ্যা ১৪৭% বাড়াতে আর দিকনির্দেশনার অনুরোধ ৬৩% বাড়াতে আমরা সাহায্য করেছি।",
          imageAlt: "রেস্তোরাঁর কেস স্টাডি",
        },
        {
          category: "ডেন্টাল প্র্যাকটিস",
          title: "স্থানীয় সার্চ থেকে ৮৩% বেশি নতুন রোগী",
          body:
            "আমাদের লোকাল এসইও কৌশলে একটি ডেন্টাল প্র্যাকটিস সব গুরুত্বপূর্ণ স্থানীয় কি-ওয়ার্ডে শীর্ষ ৩-এ উঠে এসেছে, ফলে নতুন রোগী ৮৩% বেড়েছে।",
          imageAlt: "ডেন্টাল প্র্যাকটিসের কেস স্টাডি",
        },
        {
          category: "হোম সার্ভিস",
          title: "লোকাল এসইও ক্যাম্পেইন থেকে ২১৫% আরওআই",
          body:
            "একটি প্লাম্বিং প্রতিষ্ঠানকে ৫টি শহরের স্থানীয় সার্চে এগিয়ে দিতে আমরা সাহায্য করেছি, ফলে তাদের লোকাল এসইও বিনিয়োগে ২১৫% আরওআই এসেছে।",
          imageAlt: "হোম সার্ভিসের কেস স্টাডি",
        },
      ],
    },
    faq: {
      title: "সাধারণ জিজ্ঞাসা",
      intro: "আমাদের লোকাল এসইও সেবা নিয়ে সাধারণ প্রশ্নের উত্তর জেনে নিন।",
      items: [
        {
          question: "লোকাল এসইওর ফল পেতে কত সময় লাগে?",
          answer:
            "বেশিরভাগ ক্লায়েন্ট ৩০-৬০ দিনের মধ্যে স্থানীয় র‍্যাংকিংয়ে উন্নতি দেখতে শুরু করেন, আর বড় ফল সাধারণত ৩-৬ মাসের মধ্যে আসে। সময়টা নির্ভর করে আপনি কোথা থেকে শুরু করছেন, প্রতিযোগিতা কেমন আর কৌশলটি কতটা বিস্তৃত তার উপর।",
        },
        {
          question: "প্রতিটি শাখার জন্য কি আলাদা লোকাল এসইও কৌশল লাগে?",
          answer:
            "হ্যাঁ, প্রতিটি শাখার জন্য আলাদা কৌশল দরকার। এর মধ্যে থাকে আলাদা Google Business Profile, এলাকাভিত্তিক কনটেন্ট আর প্রতিটি সেবা এলাকার জন্য লক্ষ্যভিত্তিক সাইটেশন। আমাদের মাল্টি-লোকেশন প্যাকেজ এই কাজটাই সহজে সামলানোর জন্য সাজানো।",
        },
        {
          question: "লোকাল এসইও ক্যাম্পেইনের সাফল্য কীভাবে মাপেন?",
          answer:
            "আমরা একাধিক কেপিআই দেখি — লোকাল প্যাক র‍্যাংকিং, স্থানীয় কি-ওয়ার্ডে অর্গানিক র‍্যাংকিং, Google Business Profile-এর হিসাব (দেখা, ক্লিক, কল, দিকনির্দেশনার অনুরোধ), স্থানীয় সার্চ থেকে আসা ট্রাফিক আর সবচেয়ে গুরুত্বপূর্ণ, স্থানীয় সার্চ থেকে আসা কনভার্শন।",
        },
        {
          question: "আপনাদের লোকাল এসইও সেবা আলাদা কেন?",
          answer:
            "আমাদের পদ্ধতিতে মিশে থাকে ডেটাভিত্তিক কৌশল, এলাকাভিত্তিক কনটেন্ট তৈরি আর উন্নত কারিগরি অপ্টিমাইজেশন। স্থানীয় ল্যান্ডিং পেজের কনভার্শন হার বাড়ানোতেও আমরা জোর দিই, যাতে আপনি কেবল বেশি দৃশ্যমানতা নয়, বেশি ক্রেতাও পান।",
        },
      ],
    },
    cta: {
      title: "স্থানীয় সার্চে এগিয়ে যেতে প্রস্তুত?",
      body: "বিনামূল্যে লোকাল এসইও অডিট নিন আর দেখুন আমরা কীভাবে আপনার ব্যবসায় আরও স্থানীয় ক্রেতা আনতে পারি।",
      primary: "বিনামূল্যে লোকাল এসইও অডিট নিন",
      secondary: "পরামর্শের সময় নিন",
    },
  },
});
