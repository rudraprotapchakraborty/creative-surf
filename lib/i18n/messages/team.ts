...
export const teamMessages = defineMessages({
  ...
  bn: {
    ...
    hero: {
      eyebrow: "আমরা কারা",
      title: "টিমের সাথে পরিচিত হোন",
      subtitle:
        "ছোট একটি দল, বড় পরিসরের কাজ — কৌশল, ডেভেলপমেন্ট, ভিজ্যুয়াল আর গল্প বলা সবই এক ছাদের নিচে।",
    },
    roles: {
      marketingLead: "ডিজিটাল মার্কেটিং লিড",
      webDeveloper: "ওয়েব ডেভেলপার",
      contentStrategist: "কনটেন্ট স্ট্র্যাটেজিস্ট",
      visualiser: "সিনিয়র ভিজ্যুয়ালাইজার | এডিটর",
    },
    bios: {
      marketingLead:
        "আমাদের ক্যাম্পেইন ও গ্রোথের কাজ পরিচালনা করেন, পাশাপাশি ক্লায়েন্ট ও পার্টনারশিপ দেখাশোনা করেন।",
      webDeveloper:
        "ইন্টারফেস থেকে ইনফ্রাস্ট্রাকচার পর্যন্ত Creative Surf প্ল্যাটফর্ম তৈরি ও রক্ষণাবেক্ষণ করেন।",
      contentStrategist:
        "আমাদের ক্যাম্পেইন, ব্লগ আর ব্র্যান্ড ভয়েসের পেছনের শব্দগুলো সাজান।",
      visualiser:
        "ভাবনাকে ভিজ্যুয়ালে রূপ দেন — ডিজাইন, মোশন আর সব মিলিয়ে দেওয়া এডিট।",
      editor:
        "প্রথম স্টোরিবোর্ড থেকে চূড়ান্ত কাট পর্যন্ত আমাদের ভিডিও ও ভিজ্যুয়াল কাজ গড়ে তোলেন।",
    },
    cta: {
      title: "আমাদের সাথে কাজ করতে চান?",
      body: "নতুন প্রকল্প আর ভাবনার কথা শুনতে আমরা সবসময়ই আগ্রহী।",
      button: "যোগাযোগ করুন",
    },
  },
});
