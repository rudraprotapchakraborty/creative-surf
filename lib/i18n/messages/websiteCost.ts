...
export const websiteCostMessages = defineMessages({
  en: {
    metaTitle: "How Much Should a Website Cost?",
    metaDescription:
    ...
    factorsTitle: "Website Cost Factors",
    factorsBody:
      "The cost of a website can vary significantly based on several factors. Understanding these factors can help you budget appropriately for your website project.",
    typeTitle: "Website Type",
    typeIntro: "Different types of websites have different complexity levels and therefore different costs:",
    tiers: [
      { label: "Basic informational website:", range: "$5,000 - $10,000" },
      { label: "Small business website:", range: "$10,000 - $25,000" },
      { label: "E-commerce website:", range: "$25,000 - $50,000+" },
      { label: "Custom web application:", range: "$50,000 - $250,000+" },
    ],
    cta: {
      title: "Ready to Get Started?",
      body: "Contact us today for a personalized quote for your website project.",
      button: "Get a Free Website Quote",
    },
  },
  ...
  bn: {
    metaTitle: "একটি ওয়েবসাইটের খরচ কত হওয়া উচিত?",
    metaDescription:
      "ওয়েবসাইট তৈরির খরচ এবং বিভিন্ন ধরনের ওয়েবসাইটের দাম কোন বিষয়গুলোর উপর নির্ভর করে তা জেনে নিন।",
    breadcrumb: {
      pricingGuides: "মূল্য নির্দেশিকা",
      current: "ওয়েবসাইটের খরচ",
    },
    title: "একটি ওয়েবসাইটের খরচ কত হওয়া উচিত?",
    subtitle:
      "ওয়েবসাইট তৈরির খরচ এবং ওয়েবসাইটের ধরন অনুযায়ী দাম কোন বিষয়গুলোর উপর নির্ভর করে তা বুঝে নিন।",
    factorsTitle: "ওয়েবসাইটের খরচ নির্ধারণকারী বিষয়",
    factorsBody:
      "কয়েকটি বিষয়ের উপর ভিত্তি করে একটি ওয়েবসাইটের খরচ অনেকটাই বদলে যেতে পারে। এগুলো বুঝলে আপনি প্রকল্পের জন্য বাস্তবসম্মত বাজেট করতে পারবেন।",
    typeTitle: "ওয়েবসাইটের ধরন",
    typeIntro: "বিভিন্ন ধরনের ওয়েবসাইটের জটিলতা আলাদা, তাই খরচও আলাদা:",
    tiers: [
      { label: "সাধারণ তথ্যভিত্তিক ওয়েবসাইট:", range: "$5,000 - $10,000" },
      { label: "ছোট ব্যবসার ওয়েবসাইট:", range: "$10,000 - $25,000" },
      { label: "ই-কমার্স ওয়েবসাইট:", range: "$25,000 - $50,000+" },
      { label: "কাস্টম ওয়েব অ্যাপ্লিকেশন:", range: "$50,000 - $250,000+" },
    ],
    cta: {
      title: "শুরু করতে প্রস্তুত?",
      body: "আপনার ওয়েবসাইট প্রকল্পের জন্য ব্যক্তিগত কোটেশন পেতে আজই যোগাযোগ করুন।",
      button: "বিনামূল্যে ওয়েবসাইট কোটেশন নিন",
    },
  },
});
