...
export const aboutHistoryMessages = defineMessages({
  en: {
    ...
    hero: {
      title: "Our Journey",
      subtitle:
        "From a small team of passionate marketers to a leading digital marketing agency, discover the story behind CreativeSurf.",
      imageAlt: "CreativeSurf History",
    },
    ...
    timeline: [
      {
        title: "The Beginning",
        body:
          "CreativeSurf was founded by a small team of digital marketing experts with a vision to help businesses navigate the complex digital landscape. Starting with just 5 team members in a small office, we began offering SEO and content marketing services to local businesses.",
        imageAlt: "CreativeSurf Founding",
      },
      {
        title: "Expansion & Innovation",
        body:
          "Despite the global challenges, 2020 was a year of growth for CreativeSurf. We expanded our service offerings to include web design and social media marketing. Our team doubled in size, and we moved to a larger office space to accommodate our growing team.",
        imageAlt: "CreativeSurf Growth",
      },
      {
        title: "Industry Recognition",
        body:
          "Our commitment to excellence was recognized as we won our first industry awards for outstanding digital marketing campaigns. We launched our proprietary analytics platform, helping clients gain deeper insights into their marketing performance.",
        imageAlt: "CreativeSurf Awards",
      },
      {
        title: "National Expansion",
        body:
          "CreativeSurf expanded its reach nationally, opening offices in three major cities. We launched our digital marketing academy, providing training and resources to help businesses and professionals enhance their digital marketing skills.",
        imageAlt: "CreativeSurf National Expansion",
      },
      {
        title: "International Growth",
        body:
          "We took our first steps into international markets, establishing partnerships with agencies in Europe and Asia. Our team grew to over 100 experts, and we introduced advanced AI-powered marketing solutions to our service offerings.",
        imageAlt: "CreativeSurf International Growth",
      },
      {
        title: "Innovation & Future Focus",
        body:
          "Today, CreativeSurf continues to innovate and lead in the digital marketing space. We've launched our sustainability initiative, committed to reducing our environmental impact and helping clients develop sustainable marketing practices. With a focus on emerging technologies like AI and the metaverse, we're preparing our clients for the future of digital marketing.",
        imageAlt: "CreativeSurf Today",
      },
    ],
    valuesTitle: "Our Enduring Values",
    values: [
      {
        title: "Innovation",
        body:
          "From day one, we've been committed to staying at the forefront of digital marketing trends and technologies. This spirit of innovation continues to drive us forward.",
      },
      {
        title: "Client Success",
        body:
          "Our clients' success has always been our primary measure of achievement. We're proud to have helped hundreds of businesses grow and thrive in the digital landscape.",
      },
      {
        title: "Community",
        body:
          "We believe in giving back to the communities we serve. Throughout our history, we've maintained a commitment to community involvement and social responsibility.",
      },
    ],
    cta: {
      title: "Be Part of Our Future",
      body:
        "Join us as we continue to write the next chapters of the CreativeSurf story. Whether as a client, partner, or team member, there's a place for you in our journey.",
      contact: "Contact Us",
      join: "Join Our Team",
    },
  },
  ...
  bn: {
    ...
    hero: {
      title: "আমাদের যাত্রা",
      subtitle:
        "আবেগী কয়েকজন মার্কেটারের ছোট দল থেকে শীর্ষস্থানীয় ডিজিটাল মার্কেটিং এজেন্সি — CreativeSurf-এর গল্পটি জেনে নিন।",
      imageAlt: "CreativeSurf-এর ইতিহাস",
    },
    timelineTitle: "আমাদের সময়রেখা",
    timeline: [
      {
        title: "শুরুর দিনগুলো",
        body:
          "জটিল ডিজিটাল জগতে ব্যবসাগুলোকে পথ দেখানোর স্বপ্ন নিয়ে কয়েকজন ডিজিটাল মার্কেটিং বিশেষজ্ঞ মিলে CreativeSurf গড়ে তোলেন। ছোট একটি অফিসে মাত্র ৫ জন সদস্য নিয়ে শুরু করে আমরা স্থানীয় ব্যবসার জন্য এসইও আর কনটেন্ট মার্কেটিং সেবা দিতে থাকি।",
        imageAlt: "CreativeSurf-এর প্রতিষ্ঠা",
      },
      {
        title: "সম্প্রসারণ ও উদ্ভাবন",
        body:
          "বিশ্বজুড়ে নানা প্রতিকূলতার মধ্যেও ২০২০ সাল ছিল CreativeSurf-এর বেড়ে ওঠার বছর। আমরা সেবার তালিকায় ওয়েব ডিজাইন আর সোশ্যাল মিডিয়া মার্কেটিং যোগ করি। টিমের আকার দ্বিগুণ হয়, আর বাড়তি জায়গার জন্য আমরা বড় অফিসে চলে যাই।",
        imageAlt: "CreativeSurf-এর বেড়ে ওঠা",
      },
      {
        title: "ইন্ডাস্ট্রির স্বীকৃতি",
        body:
          "অসাধারণ ডিজিটাল মার্কেটিং ক্যাম্পেইনের জন্য প্রথম ইন্ডাস্ট্রি পুরস্কার জিতে আমাদের নিষ্ঠার স্বীকৃতি মেলে। আমরা নিজস্ব অ্যানালিটিক্স প্ল্যাটফর্ম চালু করি, যা ক্লায়েন্টদের মার্কেটিং পারফরম্যান্স আরও গভীরভাবে বুঝতে সাহায্য করে।",
        imageAlt: "CreativeSurf-এর পুরস্কার",
      },
      {
        title: "দেশজুড়ে বিস্তার",
        body:
          "CreativeSurf দেশের তিনটি বড় শহরে অফিস খুলে কার্যক্রম ছড়িয়ে দেয়। আমরা ডিজিটাল মার্কেটিং একাডেমি চালু করি, যেখানে ব্যবসা ও পেশাজীবীদের দক্ষতা বাড়াতে প্রশিক্ষণ ও রিসোর্স দেওয়া হয়।",
        imageAlt: "CreativeSurf-এর দেশজুড়ে বিস্তার",
      },
      {
        title: "আন্তর্জাতিক বিস্তার",
        body:
          "ইউরোপ ও এশিয়ার এজেন্সিগুলোর সাথে অংশীদারিত্ব গড়ে আমরা আন্তর্জাতিক বাজারে প্রথম পা রাখি। আমাদের টিম ১০০-র বেশি বিশেষজ্ঞের হয়, আর সেবার তালিকায় যুক্ত হয় উন্নত এআই-চালিত মার্কেটিং সমাধান।",
        imageAlt: "CreativeSurf-এর আন্তর্জাতিক বিস্তার",
      },
      {
        title: "উদ্ভাবন ও ভবিষ্যতের পথে",
        body:
          "আজও CreativeSurf ডিজিটাল মার্কেটিংয়ে উদ্ভাবন করে চলেছে আর পথ দেখাচ্ছে। আমরা টেকসই উদ্যোগ চালু করেছি — পরিবেশে নিজেদের প্রভাব কমানো আর ক্লায়েন্টদের টেকসই মার্কেটিং চর্চা গড়ে তুলতে সাহায্য করা আমাদের অঙ্গীকার। এআই আর মেটাভার্সের মতো নতুন প্রযুক্তিতে নজর রেখে আমরা ক্লায়েন্টদের ডিজিটাল মার্কেটিংয়ের ভবিষ্যতের জন্য প্রস্তুত করছি।",
        imageAlt: "আজকের CreativeSurf",
      },
    ],
    valuesTitle: "আমাদের চিরন্তন মূল্যবোধ",
    values: [
      {
        title: "উদ্ভাবন",
        body:
          "প্রথম দিন থেকেই ডিজিটাল মার্কেটিংয়ের প্রবণতা আর প্রযুক্তিতে সবার আগে থাকার চেষ্টা করে এসেছি। এই উদ্ভাবনী মনোভাবই আমাদের এগিয়ে নিয়ে যায়।",
      },
      {
        title: "ক্লায়েন্টের সাফল্য",
        body:
          "ক্লায়েন্টদের সাফল্যই সবসময় আমাদের অর্জনের প্রধান মাপকাঠি। শত শত ব্যবসাকে ডিজিটাল জগতে বেড়ে উঠতে সাহায্য করতে পেরে আমরা গর্বিত।",
      },
      {
        title: "সমাজ",
        body:
          "যে সমাজের জন্য কাজ করি, তাকে কিছু ফিরিয়ে দেওয়ায় আমরা বিশ্বাস করি। শুরু থেকেই সামাজিক দায়বদ্ধতা আর সমাজে অংশগ্রহণের অঙ্গীকার আমরা ধরে রেখেছি।",
      },
    ],
    cta: {
      title: "আমাদের ভবিষ্যতের অংশ হোন",
      body:
        "CreativeSurf-এর গল্পের পরের অধ্যায়গুলো লেখায় আমাদের সঙ্গী হোন। ক্লায়েন্ট, পার্টনার কিংবা টিম সদস্য — এই যাত্রায় আপনার জন্যও জায়গা আছে।",
      contact: "যোগাযোগ করুন",
      join: "আমাদের টিমে যোগ দিন",
    },
  },
});
