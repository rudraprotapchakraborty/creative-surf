...
export const aboutReviewsMessages = defineMessages({
  en: {
    metaTitle: "Client Reviews & Testimonials",
    metaDescription:
    ...
    hero: {
      ...
      basedOn: "Based on {count} client reviews",
    },
    reviews: [
      {
    ...
    recognition: {
      ...
      items: [
        { name: "Marketing Excellence", event: "2024 Digital Innovation Awards", imageAlt: "Digital Marketing Excellence Award" },
        { name: "Best SEO Agency", event: "2023 Digital Marketing Awards", imageAlt: "Best SEO Agency" },
        { name: "Top Web Design Firm", event: "2023 Creative Excellence Awards", imageAlt: "Top Web Design Firm" },
        { name: "Best Place to Work", event: "2022 Employer Excellence Awards", imageAlt: "Best Place to Work" },
      ],
    },
    platforms: {
      title: "Find Us On Review Platforms",
      summary: "{rating} out of 5 based on {count} reviews",
      readOn: "Read {platform} Reviews",
    },
    cta: {
      title: "Ready to Experience Results Like These?",
      body:
