...
export const cvBuilderMessages = defineMessages({
  en: {
    ...
    sections: {
      ...
      photoFailed: "That photo could not be uploaded. Try again.",
      photoHint:
  ...
  fr: {
    ...
    sections: {
      ...
      photoFailed: "Impossible d'envoyer cette photo. Réessayez.",
      photoHint:
  ...
  de: {
    ...
    sections: {
      ...
      photoFailed: "Dieses Foto konnte nicht hochgeladen werden. Bitte erneut versuchen.",
      photoHint:
  ...
  ar: {
    ...
    sections: {
      ...
      photoRemove: "Ihdhif",
      photoUploading: "Jari Ar-Raf…",
      photoFailed: "Ta'adhdhara raf hadhihi As-Sura. Hawil marratan ukhra.",
      photoHint:
  ...
  bn: {
    ...
    sections: {
      ...
      links: "লিংক (ঐচ্ছিক)",
      photo: "ছবি (ঐচ্ছিক)",
      photoAdd: "ছবি আপলোড করুন",
      photoChange: "ছবি বদলান",
      photoRemove: "সরান",
      photoUploading: "আপলোড হচ্ছে…",
      photoFailed: "ছবিটি আপলোড করা গেল না। আবার চেষ্টা করুন।",
      photoHint:
