...
export const fixFunnelMessages = defineMessages({
  ...
  bn: {
    hero: {
      title: "আপনার ফানেল ঠিক করুন",
      subtitle:
        "আমাদের বিনামূল্যের ফানেল বিশ্লেষণ টুল দিয়ে কনভার্শনের বাধাগুলো চিনে নিন আর আয়ের সম্ভাবনা কাজে লাগান",
      cta: "আমার ফানেল বিশ্লেষণ করুন",
      imageAlt: "ফানেল বিশ্লেষণ ড্যাশবোর্ড",
    },
    tool: {
      title: "আপনার কনভার্শন ফানেল বিশ্লেষণ করুন",
      intro:
        "নিচে আপনার ওয়েবসাইটের তথ্য দিন আর কনভার্শন ফানেলের ব্যক্তিগত বিশ্লেষণ পান, সাথে ফল বাড়ানোর কাজে লাগানোর মতো পরামর্শ।",
      stepLabels: ["খাত", "ট্রাফিক", "কনভার্শন", "আয়"],
      back: "পেছনে",
      next: "পরবর্তী",
      analyze: "আমার ফানেল বিশ্লেষণ করুন",
      steps: {
        industry: {
          title: "আপনার খাত বেছে নিন",
          body: "খাতের মানদণ্ডের সাথে মিলিয়ে আমরা আপনার পারফরম্যান্স যাচাই করব।",
          label: "খাত",
          placeholder: "আপনার খাত বেছে নিন",
        },
        traffic: {
          title: "ওয়েবসাইট ট্রাফিক",
          body: "আপনার মাসিক ওয়েবসাইট দর্শক সম্পর্কে বলুন।",
          label: "মাসিক ওয়েবসাইট দর্শক",
          placeholder: "যেমন, 10000",
        },
        conversions: {
          title: "কনভার্শন হার",
          body: "কত শতাংশ দর্শক লিড বা ক্রেতায় পরিণত হন?",
          label: "কনভার্শন হার (%)",
          placeholder: "যেমন, 2.5",
        },
        revenue: {
          title: "গড় আয়",
          body: "প্রতি কনভার্শনে আপনার গড় আয় কত?",
          label: "প্রতি কনভার্শনে গড় আয় ($)",
      ...
      industries: {
        ...
        education: "শিক্ষা",
        travel: "ভ্রমণ ও আতিথেয়তা",
        realestate: "রিয়েল এস্টেট",
        other: "অন্যান্য",
      },
    },
    results: {
      title: "আপনার ফানেল বিশ্লেষণ",
      subtitle: "আপনার দেওয়া তথ্যের ভিত্তিতে আপনার ফানেল যেমন চলছে",
      currentTitle: "বর্তমান পারফরম্যান্স",
      currentLabel: "মাসিক আয়",
      potentialTitle: "সম্ভাব্য প্রবৃদ্ধি",
      potentialLabel: "বাড়তি আয়ের সম্ভাবনা",
      benchmarkTitle: "খাতের মানদণ্ড",
      benchmarkLabel: "গড় কনভার্শন হার",
      recommendationsTitle: "ফানেল উন্নত করার পরামর্শ",
      recommendations: [
        "স্পষ্ট কল-টু-অ্যাকশন আর মূল্য প্রস্তাব দিয়ে ল্যান্ডিং পেজ সাজিয়ে নিন",
        "কোন উপাদানগুলো সবচেয়ে কার্যকর তা বুঝতে এ/বি টেস্টিং চালু করুন",
        "ঝরে পড়া কমাতে চেকআউট বা ফর্ম জমার প্রক্রিয়া সহজ করুন",
        "যাঁরা কনভার্ট করেননি তাঁদের ফেরাতে রিটার্গেটিং ক্যাম্পেইন চালু করুন",
        "বাউন্স রেট কমাতে আর অভিজ্ঞতা ভালো করতে পেজ লোডের গতি বাড়ান",
      ],
      startOver: "আবার শুরু করুন",
      customStrategy: "নিজের জন্য ফানেল কৌশল নিন",
    },
    howItWorks: {
      title: "আমাদের ফানেল বিশ্লেষণ যেভাবে কাজ করে",
      intro:
        "আপনার সেলস ফানেলে সুযোগ খুঁজে বের করতে আমাদের টুল খাতের মানদণ্ড আর কনভার্শন অপ্টিমাইজেশনের সেরা চর্চা কাজে লাগায়।",
      items: [
        {
          title: "ডেটা বিশ্লেষণ",
          body: "আপনার বর্তমান ট্রাফিক, কনভার্শন হার আর আয় বিশ্লেষণ করে আমরা আপনার ভিত্তি পারফরম্যান্স ঠিক করি।",
        },
        {
          title: "মানদণ্ডের সাথে তুলনা",
          body: "ঘাটতি আর সুযোগ চিনতে আপনার হিসাবগুলো খাতের মানদণ্ডের সাথে মিলিয়ে দেখা হয়।",
        },
        {
          title: "কাজে লাগানোর মতো পরামর্শ",
          body: "কনভার্শন ফানেলের প্রতিটি ধাপ সাজিয়ে নিতে আপনার জন্য পরামর্শ পান।",
        },
      ],
    },
    useCases: {
      title: "কাদের কাজে লাগবে",
      intro: "আমাদের ফানেল বিশ্লেষণ টুল সব আকারের ব্যবসাকে কনভার্শনের বাধা চিনতে ও ঠিক করতে সাহায্য করে।",
      tabs: ["ই-কমার্স", "সাস (SaaS)", "সেবাভিত্তিক ব্যবসা"],
      items: [
        {
          title: "ই-কমার্স স্টোর",
          body: "ক্রেতারা কেন কার্ট ছেড়ে চলে যান তা বুঝে নিন আর বেশি কনভার্শনের জন্য প্রোডাক্ট পেজ সাজিয়ে নিন।",
          issuesTitle: "ই-কমার্স ফানেলের সাধারণ সমস্যা:",
          issues: [
            "কার্ট ছেড়ে যাওয়ার উঁচু হার (খাতের গড়: ৬৯.৫৭%)",
            "প্রোডাক্ট পেজে দুর্বল কনভার্শন হার",
            "চেকআউটে বাধা, যার কারণে ক্রেতা ঝরে পড়েন",
            "কম গড় অর্ডার মূল্য",
          ],
        },
        {
          title: "সাস (SaaS) প্রতিষ্ঠান",
          body: "ট্রায়াল থেকে পেইড হওয়ার হার বাড়ান আর সাবস্ক্রিপশন ফানেলে গ্রাহক হারানো কমান।",
          issuesTitle: "সাস ফানেলের সাধারণ সমস্যা:",
          issues: [
            "ট্রায়াল থেকে পেইড হওয়ার কম হার",
            "গ্রাহক অর্জনে উঁচু খরচ",
            "অনবোর্ডিং শেষ করার কম হার",
            "শুরুতেই সাবস্ক্রিপশন বাতিল",
          ],
        },
        {
          title: "সেবাভিত্তিক ব্যবসা",
          body: "আপনার সেবাভিত্তিক ব্যবসার লিড জেনারেশন আর পরামর্শ বুকিংয়ের হার বাড়ান।",
          issuesTitle: "সেবাভিত্তিক ব্যবসার ফানেলের সাধারণ সমস্যা:",
          issues: [
            "ফর্ম পূরণের কম হার",
            "লিডের দুর্বল মান",
            "পরামর্শ বুকিংয়ের কম হার",
            "পরামর্শে অনুপস্থিতির উঁচু হার",
          ],
        },
      ],
    },
    testimonials: {
      title: "সাফল্যের গল্প",
      intro: "আমাদের ফানেল বিশ্লেষণ ব্যবহার করে ব্যবসাগুলো কীভাবে কনভার্শন বাড়িয়েছে দেখুন।",
      items: [
        {
          role: "ই-কমার্স ডিরেক্টর",
          quote:
            "ফানেল বিশ্লেষণ টুলটি আমাদের চেকআউট প্রক্রিয়ার একটি বড় ঝরে পড়ার জায়গা ধরিয়ে দিয়েছে। পরামর্শ অনুযায়ী বদল আনার পর আমাদের কনভার্শন হার ২৮% বেড়েছে।",
        },
        {
          role: "মার্কেটিং ম্যানেজার",
          quote:
            "লিডের মান নিয়ে আমরা সমস্যায় ছিলাম। ফানেল বিশ্লেষণ আমাদের লিড ক্যাপচার ফর্ম নতুন করে সাজাতে সাহায্য করেছে, ফলে লিড ৩৫% কমলেও সেগুলোর মান অনেক ভালো আর কনভার্শনও বেশি।",
        },
        {
          role: "সাস প্রতিষ্ঠাতা",
          quote:
            "আমাদের ট্রায়াল থেকে পেইড হওয়ার হার ৮%-এ আটকে ছিল। ফানেল বিশ্লেষণ টুল ব্যবহার করে পরামর্শগুলো কাজে লাগানোর পর তা ১২.৫%-এ পৌঁছেছে, যা আমাদের ব্যবসা বদলে দিয়েছে।",
        },
      ],
    },
    faq: {
      title: "সাধারণ জিজ্ঞাসা",
      intro: "আমাদের ফানেল বিশ্লেষণ টুল নিয়ে সাধারণ প্রশ্নের উত্তর জেনে নিন।",
      items: [
        {
          question: "ফানেল বিশ্লেষণ কতটা নির্ভুল?",
          answer:
            "আমাদের ফানেল বিশ্লেষণ টুল খাতের মানদণ্ড আর কনভার্শন অপ্টিমাইজেশনের সেরা চর্চা কাজে লাগিয়ে নির্ভুল ধারণা দেয়। পরামর্শগুলো নানা খাতের হাজার হাজার সফল ওয়েবসাইট ও ক্যাম্পেইনের ডেটার ভিত্তিতে দেওয়া।",
        },
        {
          question: "আমার তথ্য কি নিরাপদ?",
          answer:
            "হ্যাঁ, তথ্যের নিরাপত্তাকে আমরা গুরুত্ব দিই। আপনার দেওয়া তথ্য কেবল আপনার ফানেল বিশ্লেষণ তৈরিতেই ব্যবহার হয়, তা সংরক্ষণ বা তৃতীয় পক্ষের সাথে ভাগ করা হয় না। বিশ্লেষণের জন্য আমাদের কোনো সংবেদনশীল ব্যবসায়িক তথ্য লাগে না।",
        },
        {
          question: "পরামর্শগুলো কীভাবে কাজে লাগাব?",
          answer:
            "বিশ্লেষণ পাওয়ার পর আপনি নিজেই পরামর্শগুলো কাজে লাগাতে পারেন, কিংবা আমাদের বিশেষজ্ঞ টিমের সাথে কাজ করতে পারেন যাঁরা পরিবর্তনগুলো বাস্তবায়নে সাহায্য করবেন। সর্বোচ্চ ফল পেতে আমরা নিজস্ব ফানেল অপ্টিমাইজেশন সেবাও দিই।",
        },
        {
          question: "ফল দেখতে কত সময় লাগে?",
          answer:
            "বেশিরভাগ ব্যবসা আমাদের পরামর্শ কাজে লাগানোর ২-৪ সপ্তাহের মধ্যেই উন্নতি দেখতে শুরু করে। তবে সময়টা আপনার ট্রাফিকের পরিমাণ, খাত আর কী কী বদল আনা হয়েছে তার উপর নির্ভর করে।",
        },
        {
          question: "আরও বিস্তারিত বিশ্লেষণ পাওয়া যাবে?",
          answer:
            "হ্যাঁ! আমাদের বিনামূল্যের টুল প্রাথমিক বিশ্লেষণ দেয়, তবে আমরা গভীর কাস্টম ফানেল অডিটও করি, যেখানে থাকে বিস্তারিত হিটম্যাপ বিশ্লেষণ, ব্যবহারকারীর সেশন রেকর্ডিং আর আপনার জন্য সাজানো অপ্টিমাইজেশন কৌশল। বিস্তারিত জানতে যোগাযোগ করুন।",
        },
      ],
    },
    cta: {
      title: "কনভার্শন ফানেল সাজিয়ে নিতে প্রস্তুত?",
      body: "আমাদের বিনামূল্যের বিশ্লেষণ টুল দিয়ে শুরু করুন, কিংবা পূর্ণাঙ্গ ফানেল অডিটের জন্য আমাদের বিশেষজ্ঞদের সাথে যোগাযোগ করুন।",
      primary: "এখনই আমার ফানেল বিশ্লেষণ করুন",
      secondary: "বিশেষজ্ঞের সাহায্য নিন",
    },
  },
});
