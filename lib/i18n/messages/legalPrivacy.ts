...
export const legalPrivacyMessages = defineMessages({
  en: {
    metaTitle: "Privacy Policy",
    metaDescription: "Privacy Policy for Creative Surf's website and services.",
    ...
    sections: [
      {
        ...
        blocks: [
          { type: "p", text: "Creative Surf (\"Company\", \"we\", \"our\", or \"us\") respects your privacy and is committed to protecting your personal information. This Privacy Policy explains how we collect, use, disclose, and safeguard information when you visit our website, use our services, or communicate with us." },
          { type: "p", text: "By using our website and services, you agree to the collection and use of information in accordance with this Privacy Policy." },
        ],
      },
      {
        heading: "2. Information We Collect",
        blocks: [
          { type: "strong", text: "Personal Information" },
          { type: "p", text: "We may collect information that you voluntarily provide, including:" },
          {
            type: "ul",
            items: [
              "Full name",
              ...
              "Company name",
              "Business website",
              "Marketing goals and project requirements",
              "Billing information",
            ],
          },
          { type: "strong", text: "Automatically Collected Information" },
          { type: "p", text: "When you visit our website, we may automatically collect:" },
          {
            type: "ul",
            items: [
              "IP address",
        ...
        blocks: [
          { type: "p", text: "We use collected information to:" },
          {
            ...
            items: [
              ...
              "Deliver reports and campaign insights",
      ...
      },
      {
        ...
        blocks: [
          { type: "p", text: "We may send promotional emails, newsletters, and service updates. You may unsubscribe at any time using the unsubscribe link contained in our emails." },
        ],
      },
      {
        heading: "5. Third-Party Services",
        blocks: [
          { type: "p", text: "We may use third-party providers including:" },
          {
            type: "ul",
            items: [
          ...
          { type: "p", text: "These providers maintain their own privacy policies and practices." },
        ],
      },
      {
        ...
        blocks: [
          ...
          { type: "p", text: "We may share information with:" },
          {
            ...
            items: [
              ...
              "Advertising platforms when managing campaigns",
      ...
      },
      {
        ...
        blocks: [
          { type: "p", text: "We implement reasonable administrative, technical, and organizational safeguards designed to protect personal information. However, no internet transmission or storage system can be guaranteed to be 100% secure." },
        ],
      },
      {
        heading: "8. Data Retention",
        blocks: [
          { type: "p", text: "We retain information only for as long as necessary to provide services, comply with legal obligations, resolve disputes, and enforce agreements." },
        ],
      },
      {
      ...
      },
      {
        heading: "10. Cookies",
        blocks: [
          { type: "p", text: "Our website may use cookies and similar technologies to improve user experience, analyze traffic, and support advertising efforts." },
          { type: "p", text: "You can control cookies through your browser settings." },
        ],
      },
      {
        heading: "11. Children's Privacy",
        blocks: [
          { type: "p", text: "Our services are not directed to individuals under 18 years of age. We do not knowingly collect personal information from minors." },
        ],
      },
      {
        heading: "12. International Data Transfers",
        blocks: [
          { type: "p", text: "Your information may be transferred to and processed in countries other than your own. By using our services, you consent to such transfers." },
        ],
      },
      {
        heading: "13. Changes to This Policy",
        blocks: [
          { type: "p", text: "We may update this Privacy Policy periodically. Updates become effective immediately upon posting on this page." },
        ],
      },
    ],
  },
  ...
  bn: {
    ...
    metaDescription: "Creative Surf-এর ওয়েবসাইট ও সেবার গোপনীয়তা নীতি।",
    breadcrumbCurrent: "গোপনীয়তা নীতি",
    ...
    sections: [
      {
        heading: "১. ভূমিকা",
        blocks: [
          { type: "p", text: "Creative Surf (\"প্রতিষ্ঠান\", \"আমরা\", \"আমাদের\") আপনার গোপনীয়তাকে সম্মান করে এবং আপনার ব্যক্তিগত তথ্য সুরক্ষিত রাখতে প্রতিশ্রুতিবদ্ধ। আপনি যখন আমাদের ওয়েবসাইটে আসেন, সেবা নেন কিংবা আমাদের সাথে যোগাযোগ করেন, তখন আমরা কীভাবে তথ্য সংগ্রহ, ব্যবহার, প্রকাশ ও সুরক্ষিত রাখি তা এই গোপনীয়তা নীতিতে ব্যাখ্যা করা হয়েছে।" },
          { type: "p", text: "আমাদের ওয়েবসাইট ও সেবা ব্যবহার করার মাধ্যমে আপনি এই গোপনীয়তা নীতি অনুযায়ী তথ্য সংগ্রহ ও ব্যবহারে সম্মতি দিচ্ছেন।" },
        ],
      },
      {
        heading: "২. আমরা যেসব তথ্য সংগ্রহ করি",
        blocks: [
          { type: "strong", text: "ব্যক্তিগত তথ্য" },
          { type: "p", text: "আপনি স্বেচ্ছায় যেসব তথ্য দেন, তা আমরা সংগ্রহ করতে পারি, যেমন:" },
          {
            type: "ul",
            items: [
              "পুরো নাম",
              ...
              "মার্কেটিং লক্ষ্য ও প্রকল্পের প্রয়োজনীয়তা",
              "বিলিং তথ্য",
            ],
          },
          { type: "strong", text: "স্বয়ংক্রিয়ভাবে সংগৃহীত তথ্য" },
          { type: "p", text: "আপনি আমাদের ওয়েবসাইটে এলে আমরা স্বয়ংক্রিয়ভাবে সংগ্রহ করতে পারি:" },
          {
            type: "ul",
            items: [
              "আইপি ঠিকানা",
          ...
          { type: "strong", text: "চ্যাট সহকারীর কথোপকথন" },
          { type: "p", text: "আপনি আমাদের ওয়েবসাইটে চ্যাট সহকারী ব্যবহার করলে আমরা পুরো কথোপকথনটি — আপনার বার্তা ও সহকারীর উত্তর — সংরক্ষণ করি, সাথে থাকে আপনি কোন পেজ থেকে শুরু করেছেন, আপনার ভাষা আর একটি নামহীন ব্রাউজার শনাক্তকারী। আপনি সাইন ইন করা থাকলে কথোপকথনটি আপনার অ্যাকাউন্টের সাথে যুক্ত হয়। এই রেকর্ডগুলো অনির্দিষ্টকাল সংরক্ষিত থাকে আর আমাদের প্রশাসকেরা পড়তে পারেন; উত্তর তৈরির জন্য আপনার বার্তাগুলো আমাদের এআই সরবরাহকারীদের কাছেও পাঠানো হয়। অনুগ্রহ করে চ্যাটে পাসওয়ার্ড, পেমেন্টের তথ্য বা অন্য সংবেদনশীল কিছু দেবেন না। নিচের যোগাযোগের তথ্য ব্যবহার করে আপনি যেকোনো সময় আপনার কথোপকথন মুছে ফেলতে বলতে পারেন।" },
        ],
      },
      {
        heading: "৩. আমরা আপনার তথ্য যেভাবে ব্যবহার করি",
        blocks: [
          { type: "p", text: "সংগৃহীত তথ্য আমরা ব্যবহার করি:" },
          {
            type: "ul",
            items: [
              "মার্কেটিং সেবা দিতে",
              "জিজ্ঞাসার উত্তর দিতে",
              "পরামর্শের সময় ঠিক করতে",
              "পেমেন্ট প্রক্রিয়া করতে",
              "আমাদের ওয়েবসাইট ও সেবা উন্নত করতে",
              "সেবার আপডেট পাঠাতে",
              "রিপোর্ট ও ক্যাম্পেইন বিশ্লেষণ দিতে",
              "আইনি বাধ্যবাধকতা মানতে",
              "প্রতারণা ও অপব্যবহার ঠেকাতে",
            ],
          },
        ],
      },
      {
        heading: "৪. মার্কেটিং যোগাযোগ",
        blocks: [
          { type: "p", text: "আমরা প্রচারমূলক ইমেইল, নিউজলেটার আর সেবার আপডেট পাঠাতে পারি। আমাদের ইমেইলে থাকা আনসাবস্ক্রাইব লিংক ব্যবহার করে আপনি যেকোনো সময় তা বন্ধ করতে পারেন।" },
        ],
      },
      {
        heading: "৫. তৃতীয় পক্ষের সেবা",
        blocks: [
          { type: "p", text: "আমরা তৃতীয় পক্ষের সরবরাহকারী ব্যবহার করতে পারি, যেমন:" },
          {
            type: "ul",
            items: [
              "Meta (Facebook ও Instagram)",
              "Google",
              "TikTok",
              "LinkedIn",
              ...
              "সিআরএম সিস্টেম",
              "পেমেন্ট প্রসেসর",
              "ইমেইল মার্কেটিং সরবরাহকারী",
            ],
          },
          { type: "p", text: "এই সরবরাহকারীদের নিজস্ব গোপনীয়তা নীতি ও চর্চা রয়েছে।" },
        ],
      },
      {
        heading: "৬. তথ্য বিনিময়",
        blocks: [
          { type: "p", text: "আমরা ব্যক্তিগত তথ্য বিক্রি করি না।" },
          { type: "p", text: "আমরা তথ্য ভাগ করতে পারি:" },
          {
            type: "ul",
            items: [
              "আমাদের কাজে সহায়তাকারী সেবা সরবরাহকারীদের সাথে",
              "ক্যাম্পেইন পরিচালনার সময় বিজ্ঞাপন প্ল্যাটফর্মের সাথে",
              "আইনত প্রয়োজন হলে আইনি কর্তৃপক্ষের সাথে",
              "একীভবন, অধিগ্রহণ বা বিক্রির ক্ষেত্রে ব্যবসার উত্তরাধিকারীর সাথে",
            ],
          },
        ],
      },
      {
        heading: "৭. তথ্য নিরাপত্তা",
        blocks: [
          { type: "p", text: "ব্যক্তিগত তথ্য সুরক্ষিত রাখতে আমরা যুক্তিসঙ্গত প্রশাসনিক, কারিগরি ও প্রাতিষ্ঠানিক ব্যবস্থা নিই। তবে ইন্টারনেটে কোনো তথ্য আদানপ্রদান বা সংরক্ষণ ব্যবস্থাই শতভাগ নিরাপদ বলে নিশ্চয়তা দেওয়া যায় না।" },
        ],
      },
      {
        heading: "৮. তথ্য সংরক্ষণের মেয়াদ",
        blocks: [
          { type: "p", text: "সেবা দিতে, আইনি বাধ্যবাধকতা মানতে, বিরোধ নিষ্পত্তি করতে আর চুক্তি কার্যকর রাখতে যতদিন প্রয়োজন কেবল ততদিনই আমরা তথ্য রাখি।" },
        ],
      },
      {
        heading: "৯. আপনার অধিকার",
        blocks: [
          { type: "p", text: "আপনার অবস্থানভেদে আপনার যেসব অধিকার থাকতে পারে:" },
          {
            type: "ul",
            items: [
              "আপনার ব্যক্তিগত তথ্য দেখা",
              "ভুল তথ্য সংশোধন করা",
              "তথ্য মুছে ফেলার অনুরোধ করা",
              "প্রক্রিয়াকরণ সীমিত করা",
              "প্রক্রিয়াকরণে আপত্তি জানানো",
              "তথ্য স্থানান্তরের অনুরোধ করা",
            ],
          },
          { type: "p", text: "এই অধিকারগুলো প্রয়োগ করতে নিচের তথ্য ব্যবহার করে আমাদের সাথে যোগাযোগ করুন।" },
        ],
      },
      {
        heading: "১০. কুকি",
        blocks: [
          { type: "p", text: "ব্যবহারকারীর অভিজ্ঞতা উন্নত করতে, ট্রাফিক বিশ্লেষণ করতে আর বিজ্ঞাপনে সহায়তা করতে আমাদের ওয়েবসাইট কুকি ও অনুরূপ প্রযুক্তি ব্যবহার করতে পারে।" },
          { type: "p", text: "ব্রাউজারের সেটিংস থেকে আপনি কুকি নিয়ন্ত্রণ করতে পারেন।" },
        ],
      },
      {
        heading: "১১. শিশুদের গোপনীয়তা",
        blocks: [
          { type: "p", text: "আমাদের সেবা ১৮ বছরের কম বয়সীদের জন্য নয়। আমরা জেনেশুনে অপ্রাপ্তবয়স্কদের ব্যক্তিগত তথ্য সংগ্রহ করি না।" },
        ],
      },
      {
        heading: "১২. আন্তর্জাতিক তথ্য স্থানান্তর",
        blocks: [
          { type: "p", text: "আপনার তথ্য আপনার দেশের বাইরে অন্য দেশে স্থানান্তর ও প্রক্রিয়াকরণ হতে পারে। আমাদের সেবা ব্যবহার করে আপনি এই স্থানান্তরে সম্মতি দিচ্ছেন।" },
        ],
      },
      {
        heading: "১৩. এই নীতির পরিবর্তন",
        blocks: [
          { type: "p", text: "আমরা মাঝে মাঝে এই গোপনীয়তা নীতি হালনাগাদ করতে পারি। এই পেজে প্রকাশের সাথে সাথেই হালনাগাদগুলো কার্যকর হয়।" },
        ],
      },
    ],
  },
