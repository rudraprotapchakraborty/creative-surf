...
export const legalTermsMessages = defineMessages({
  en: {
    metaTitle: "Terms of Service",
    metaDescription: "Terms of Service for Creative Surf's website and services.",
    ...
    sections: [
      {
        heading: "1. Agreement",
        blocks: [
          { type: "p", text: "These Terms of Service (\"Terms\") govern your access to and use of Creative Surf's website and services." },
          { type: "p", text: "By accessing our website or engaging our services, you agree to be bound by these Terms." },
        ],
      },
      {
        heading: "2. Services",
        blocks: [
          { type: "p", text: "Creative Surf provides digital marketing and consulting services, including but not limited to:" },
          {
            type: "ul",
            items: [
              "Meta Advertising",
          ...
          { type: "p", text: "Services may be modified, expanded, or discontinued at our discretion." },
        ],
      },
      {
        ...
        blocks: [
          { type: "p", text: "Clients agree to:" },
          {
            ...
            items: [
              ...
              "Supply necessary account access",
              "Respond to requests in a timely manner",
              "Maintain ownership of advertising accounts unless otherwise agreed",
      ...
      },
      {
        ...
        blocks: [
          { type: "p", text: "All fees are outlined in service agreements, proposals, or invoices." },
          { type: "strong", text: "Payments:" },
          {
            type: "ul",
            items: [
              "Are due according to the agreed schedule",
              "May be non-refundable unless stated otherwise",
              "Do not include advertising spend unless specifically noted",
            ],
          },
          { type: "p", text: "Late payments may result in suspension of services." },
        ],
      },
      {
        heading: "5. Advertising Platforms",
        blocks: [
          { type: "p", text: "Campaign performance depends on numerous factors outside our control, including:" },
          {
            type: "ul",
            items: [
              "Market conditions",
          ...
          { type: "p", text: "We do not guarantee specific results, revenue, leads, sales, ROAS, rankings, or advertising outcomes." },
        ],
      },
      {
        heading: "6. Intellectual Property",
        blocks: [
          { type: "p", text: "All content, branding, logos, website materials, frameworks, and proprietary methodologies remain the property of Creative Surf unless otherwise agreed in writing." },
          { type: "p", text: "Clients retain ownership of their own trademarks, content, and business assets." },
        ],
      },
      {
        heading: "7. Confidentiality",
        blocks: [
          { type: "p", text: "Both parties agree to keep confidential information private and not disclose such information to third parties without consent, except where required by law." },
        ],
      },
      {
        ...
        blocks: [
          ...
          { type: "p", text: "Creative Surf shall not be liable for indirect, incidental, special, consequential, or punitive damages, including lost profits, lost revenue, business interruption, or data loss." },
          { type: "p", text: "Our total liability shall not exceed the amount paid by the client during the three months preceding the claim." },
        ],
      },
      {
        heading: "9. No Guarantees",
        blocks: [
          { type: "p", text: "Marketing and advertising involve risk." },
          { type: "p", text: "While we strive to improve performance and generate positive outcomes, we do not guarantee:" },
          {
            type: "ul",
            items: [
      ...
      },
      {
        ...
        blocks: [
          { type: "p", text: "Either party may terminate services according to the terms of the applicable service agreement." },
          { type: "strong", text: "Upon termination:" },
          {
            type: "ul",
            items: [
              "Outstanding fees remain payable",
              "Access to proprietary resources may be revoked",
              "Campaign management services will cease",
            ],
          },
        ],
      },
      {
        ...
        blocks: [
          { type: "p", text: "Clients acknowledge that services may involve third-party platforms such as Meta, Google, TikTok, LinkedIn, and other providers." },
          { type: "strong", text: "Creative Surf is not responsible for:" },
          {
            type: "ul",
            items: ["Platform outages", "Account suspensions", "Policy changes", "Platform-imposed restrictions"],
          },
        ],
      },
      {
        ...
        blocks: [
          { type: "p", text: "Clients agree to indemnify and hold Creative Surf harmless from claims, damages, liabilities, and expenses arising from their products, services, advertising content, or violations of law." },
        ],
      },
      {
      ...
      },
      {
        ...
        blocks: [
          { type: "p", text: "We reserve the right to modify these Terms at any time. Continued use of our website or services constitutes acceptance of updated Terms." },
        ],
      },
    ],
  },
  ...
  bn: {
    metaTitle: "সেবার শর্তাবলি",
    metaDescription: "Creative Surf-এর ওয়েবসাইট ও সেবার শর্তাবলি।",
    breadcrumbCurrent: "সেবার শর্তাবলি",
    title: "সেবার শর্তাবলি",
    lastUpdated: "সর্বশেষ হালনাগাদ: জুন ২০২৬",
    sections: [
      {
        heading: "১. চুক্তি",
        blocks: [
          { type: "p", text: "এই সেবার শর্তাবলি (\"শর্তাবলি\") Creative Surf-এর ওয়েবসাইট ও সেবায় আপনার প্রবেশ ও ব্যবহার নিয়ন্ত্রণ করে।" },
          { type: "p", text: "আমাদের ওয়েবসাইটে প্রবেশ করে কিংবা আমাদের সেবা নিয়ে আপনি এই শর্তাবলি মেনে চলতে সম্মত হচ্ছেন।" },
        ],
      },
      {
        heading: "২. সেবাসমূহ",
        blocks: [
          { type: "p", text: "Creative Surf ডিজিটাল মার্কেটিং ও পরামর্শ সেবা দেয়, যার মধ্যে রয়েছে (তবে এতেই সীমাবদ্ধ নয়):" },
          {
            type: "ul",
            items: [
              "Meta বিজ্ঞাপন",
          ...
          { type: "p", text: "আমাদের বিবেচনায় সেবাসমূহ পরিবর্তন, সম্প্রসারণ বা বন্ধ করা হতে পারে।" },
        ],
      },
      {
        heading: "৩. ক্লায়েন্টের দায়িত্ব",
        blocks: [
          { type: "p", text: "ক্লায়েন্ট সম্মত হন:" },
          {
            type: "ul",
            items: [
              "সঠিক তথ্য দিতে",
              "প্রয়োজনীয় অ্যাকাউন্টে প্রবেশাধিকার দিতে",
              "অনুরোধে সময়মতো সাড়া দিতে",
              "অন্য কোনো সমঝোতা না থাকলে বিজ্ঞাপন অ্যাকাউন্টের মালিকানা নিজের কাছে রাখতে",
              "প্ল্যাটফর্মের নীতি ও প্রযোজ্য আইন মেনে চলতে",
            ],
          },
        ],
      },
      {
        ...
        blocks: [
          { type: "p", text: "সব ফি সেবা চুক্তি, প্রস্তাব কিংবা চালানে উল্লেখ থাকে।" },
          { type: "strong", text: "পরিশোধ:" },
          {
            type: "ul",
            items: [
              "সম্মত সময়সূচি অনুযায়ী দিতে হবে",
              "অন্যভাবে উল্লেখ না থাকলে অফেরতযোগ্য হতে পারে",
              "আলাদাভাবে উল্লেখ না থাকলে এতে বিজ্ঞাপনের খরচ ধরা নেই",
            ],
          },
          { type: "p", text: "দেরিতে পরিশোধ করলে সেবা স্থগিত হতে পারে।" },
        ],
      },
      {
        heading: "৫. বিজ্ঞাপন প্ল্যাটফর্ম",
        blocks: [
          { type: "p", text: "ক্যাম্পেইনের ফল আমাদের নিয়ন্ত্রণের বাইরে নানা বিষয়ের উপর নির্ভর করে, যেমন:" },
          {
            type: "ul",
            items: [
              "বাজারের অবস্থা",
              "প্রতিযোগিতা",
              "প্ল্যাটফর্মের অ্যালগরিদম",
              "পণ্য ও বাজারের সামঞ্জস্য",
              "ক্লায়েন্টের অফারের মান",
            ],
          },
          { type: "p", text: "আমরা নির্দিষ্ট ফল, আয়, লিড, বিক্রি, ROAS, র‍্যাংকিং বা বিজ্ঞাপনের ফলাফলের নিশ্চয়তা দিই না।" },
        ],
      },
      {
        heading: "৬. মেধাস্বত্ব",
        blocks: [
          { type: "p", text: "লিখিতভাবে অন্য কোনো সমঝোতা না থাকলে সব কনটেন্ট, ব্র্যান্ডিং, লোগো, ওয়েবসাইট উপকরণ, কাঠামো আর নিজস্ব পদ্ধতির মালিকানা Creative Surf-এর কাছেই থাকে।" },
          { type: "p", text: "ক্লায়েন্ট নিজের ট্রেডমার্ক, কনটেন্ট আর ব্যবসায়িক সম্পদের মালিকানা ধরে রাখেন।" },
        ],
      },
      {
        heading: "৭. গোপনীয়তা",
        blocks: [
          { type: "p", text: "উভয় পক্ষই গোপনীয় তথ্য গোপন রাখতে এবং আইনত প্রয়োজন না হলে সম্মতি ছাড়া তা তৃতীয় পক্ষকে না জানাতে সম্মত হয়।" },
        ],
      },
      {
        heading: "৮. দায়ের সীমা",
        blocks: [
          { type: "p", text: "আইন যতটা অনুমোদন করে ততটা পর্যন্ত:" },
          { type: "p", text: "Creative Surf পরোক্ষ, আনুষঙ্গিক, বিশেষ, পরিণামজনিত বা শাস্তিমূলক ক্ষতির জন্য দায়ী থাকবে না, এর মধ্যে রয়েছে হারানো মুনাফা, হারানো আয়, ব্যবসায় বিঘ্ন কিংবা তথ্য হারানো।" },
          { type: "p", text: "আমাদের মোট দায় দাবি উত্থাপনের আগের তিন মাসে ক্লায়েন্টের পরিশোধিত অর্থের বেশি হবে না।" },
        ],
      },
      {
        heading: "৯. কোনো নিশ্চয়তা নয়",
        blocks: [
          { type: "p", text: "মার্কেটিং ও বিজ্ঞাপনে ঝুঁকি থাকে।" },
          { type: "p", text: "আমরা পারফরম্যান্স বাড়াতে আর ভালো ফল আনতে সর্বোচ্চ চেষ্টা করলেও নিশ্চয়তা দিই না:" },
          {
            type: "ul",
            items: [
              "নির্দিষ্ট সংখ্যক লিডের",
              "আয়ের লক্ষ্যমাত্রার",
              "সার্চ র‍্যাংকিংয়ের",
              "কনভার্শন হারের",
              "বিজ্ঞাপন অনুমোদনের",
              "প্ল্যাটফর্ম অ্যাকাউন্টের স্থিতিশীলতার",
            ],
          },
        ],
      },
      {
        heading: "১০. চুক্তি সমাপ্তি",
        blocks: [
          { type: "p", text: "প্রযোজ্য সেবা চুক্তির শর্ত অনুযায়ী যেকোনো পক্ষ সেবা বন্ধ করতে পারে।" },
          { type: "strong", text: "সমাপ্তির পর:" },
          {
            type: "ul",
            items: [
              "বকেয়া ফি পরিশোধযোগ্য থাকবে",
              "নিজস্ব রিসোর্সে প্রবেশাধিকার বাতিল হতে পারে",
              "ক্যাম্পেইন ব্যবস্থাপনা সেবা বন্ধ হয়ে যাবে",
            ],
          },
        ],
      },
      {
        heading: "১১. তৃতীয় পক্ষের প্ল্যাটফর্ম",
        blocks: [
          { type: "p", text: "ক্লায়েন্ট স্বীকার করেন যে সেবায় Meta, Google, TikTok, LinkedIn-সহ তৃতীয় পক্ষের প্ল্যাটফর্ম জড়িত থাকতে পারে।" },
          { type: "strong", text: "Creative Surf যেসবের জন্য দায়ী নয়:" },
          {
            type: "ul",
            items: ["প্ল্যাটফর্ম বন্ধ থাকা", "অ্যাকাউন্ট স্থগিত হওয়া", "নীতির পরিবর্তন", "প্ল্যাটফর্মের আরোপিত বিধিনিষেধ"],
          },
        ],
      },
      {
        heading: "১২. ক্ষতিপূরণ",
        blocks: [
          { type: "p", text: "ক্লায়েন্টের পণ্য, সেবা, বিজ্ঞাপনের কনটেন্ট কিংবা আইন লঙ্ঘন থেকে উদ্ভূত দাবি, ক্ষতি, দায় ও খরচ থেকে Creative Surf-কে মুক্ত রাখতে ক্লায়েন্ট সম্মত হন।" },
        ],
      },
      {
        heading: "১৩. প্রযোজ্য আইন",
        blocks: [
          { type: "p", text: "এই শর্তাবলি ইংল্যান্ড ও ওয়েলসের আইন অনুযায়ী পরিচালিত ও ব্যাখ্যা করা হবে।" },
        ],
      },
      {
        heading: "১৪. শর্তাবলির পরিবর্তন",
        blocks: [
          { type: "p", text: "যেকোনো সময় এই শর্তাবলি পরিবর্তনের অধিকার আমরা সংরক্ষণ করি। আমাদের ওয়েবসাইট বা সেবা ব্যবহার চালিয়ে গেলে তা হালনাগাদ শর্তাবলি মেনে নেওয়া হিসেবে গণ্য হবে।" },
        ],
      },
    ],
  },
