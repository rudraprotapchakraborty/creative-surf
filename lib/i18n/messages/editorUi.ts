...
export const editorUiMessages = defineMessages({
  ...
  bn: {
    seo: {
      metaDescriptionLabel: "মেটা ডেসক্রিপশন",
      metaPlaceholder:
        "Google সার্চ ফলাফলের জন্য সংক্ষিপ্ত বিবরণ (১৫০–১৬০ অক্ষর হলে ভালো)…",
      fallbackHint: "খালি রাখলে সারসংক্ষেপ ব্যবহার করা হবে",
      characters: "{count} অক্ষর",
      idealLength: "আদর্শ দৈর্ঘ্য",
      considerShortening: "একটু ছোট করুন",
      inboundTitle: "অভ্যন্তরীণ লিংক",
      outboundTitle: "বাইরের লিংক",
      inboundHint:
        "আপনার সাইটের ভেতরের লিংক। পুরো URL দিন (https://…)। লেবেল আর URL দুটোই আবশ্যক।",
      outboundHint: "নির্ভরযোগ্য উৎসের বাইরের লিংক। লেবেল আর URL দুটোই আবশ্যক।",
      removeLink: "লিংক সরান",
    },
    takeaways: {
      label: "মূল কথা",
      hint: "পোস্টের সারমর্ম কয়েকটি ছোট পয়েন্টে। লেখার উপরে একটি হাইলাইট কার্ডে দেখানো হয়।",
      placeholder: "যেমন: সংস্কৃতি-সচেতন এআই-এর জন্য শুধু ভাষার কভারেজই যথেষ্ট নয়।",
      itemLabel: "পয়েন্ট {number}",
      add: "পয়েন্ট যোগ করুন",
      remove: "পয়েন্ট সরান",
      moveUp: "উপরে নিন",
      moveDown: "নিচে নিন",
      count: "{count} / {max}",
    ...
    upload: {
      ...
      prompt: "ছবি আপলোড করতে ক্লিক করুন বা টেনে আনুন",
      addPhoto: "ছবি যোগ করুন",
      chooseImage: "অনুগ্রহ করে একটি ছবি ফাইল বেছে নিন।",
      chooseImagesOnly: "অনুগ্রহ করে শুধু ছবি ফাইল বেছে নিন।",
      failed: "আপলোড ব্যর্থ হয়েছে। অন্য ফাইল দিয়ে চেষ্টা করুন।",
      couldNotRead: "ফাইলটি পড়া যায়নি",
      couldNotLoad: "ছবিটি লোড করা যায়নি",
    },
    toolbar: {
      placeholder: "আপনার ব্লগ পোস্ট লেখা শুরু করুন…",
