...
export const seoServicesMessages = defineMessages({
  en: {
    ...
    hero: {
      ...
      cta: "Request a Free SEO Consultation",
      highlights: [
      ...
      items: [
        {
          ...
          body:
            "We conduct thorough research to understand your industry, competitors, and target audience to develop an effective SEO strategy.",
        },
        {
          title: "On-Page Optimization",
          body:
            "We optimize your website's content, meta tags, and structure to improve its relevance and visibility for target keywords.",
        },
        {
          title: "Content Strategy",
          body:
            "We develop a content strategy that addresses your audience's needs and positions your brand as an authority in your industry.",
        },
        {
          title: "Monitoring & Reporting",
          body:
            "We continuously monitor your SEO performance and provide regular reports with actionable insights for ongoing improvement.",
        },
      ],
    },
    benefits: {
      ...
      items: [
        {
          ...
          body:
            "Our SEO strategies are designed to increase your visibility in search results, driving more organic traffic to your website.",
        },
        {
          title: "Higher Quality Leads",
          body:
            "By targeting the right keywords and optimizing your content, we help you attract visitors who are more likely to convert into customers.",
        },
        {
          title: "Improved User Experience",
          body:
            "Our SEO services include optimizing your website's structure and content to provide a better experience for your visitors.",
        },
        {
    ...
    caseStudy: {
      ...
      title: "How We Increased Organic Traffic by 150% for a B2B Software Company",
      body:
        "A B2B software company came to us struggling to generate leads through their website. Through our comprehensive SEO strategy, we were able to:",
      results: [
        "Increase organic traffic by 150% in 6 months",
        "Improve keyword rankings for 50+ high-value terms",
        "Generate 40% more qualified leads through the website",
      ],
    ...
    packages: {
      ...
      tiers: [
        {
          name: "Basic",
          audience: "For small businesses just getting started with SEO",
          price: "$1,500",
          features: [
        ...
        {
          name: "Professional",
          audience: "For growing businesses seeking comprehensive SEO",
          price: "$3,000",
          features: [
        ...
        {
          name: "Enterprise",
          audience: "For large businesses with complex SEO needs",
          price: "$5,000+",
          features: [
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          answer:
            "We take a data-driven, transparent approach to SEO. We focus on delivering measurable results and providing clear reporting so you can see the impact of our work. Our strategies are customized to your specific business goals and target audience.",
        },
        {
          question: "Do you guarantee first-page rankings?",
          answer:
            "No reputable SEO agency can guarantee specific rankings as search algorithms are constantly evolving. We focus on implementing proven strategies that improve your visibility and drive qualified traffic, but we don't make promises we can't keep.",
        },
        {
          question: "What do I need to provide to get started?",
          answer:
            "To get started, we'll need access to your website analytics, search console, and CMS. We'll also conduct an initial consultation to understand your business goals, target audience, and current marketing efforts.",
        },
      ],
    },
    cta: {
      title: "Ready to Improve Your Search Rankings?",
      body: "Contact us today to discuss how our SEO services can help your business grow.",
      button: "Get a Free SEO Consultation",
    },
  },
  ...
  bn: {
    metaTitle: "এসইও সেবা",
    metaDescription:
      "সার্চ ইঞ্জিন র‍্যাংকিং বাড়াতে আর ওয়েবসাইটে অর্গানিক ট্রাফিক আনতে পূর্ণাঙ্গ এসইও কৌশল।",
    breadcrumbCurrent: "এসইও সেবা",
    hero: {
      title: "এসইও সেবা",
      intro:
        "সার্চ ইঞ্জিন র‍্যাংকিং বাড়াতে আর আপনার ওয়েবসাইটে অর্গানিক ট্রাফিক আনতে পূর্ণাঙ্গ এসইও কৌশল।",
      imageAlt: "এসইও সেবা",
      cta: "বিনামূল্যে এসইও পরামর্শ নিন",
      highlights: [
        "আপনার ব্যবসায়িক লক্ষ্য অনুযায়ী সাজানো এসইও কৌশল",
        "পূর্ণাঙ্গ কি-ওয়ার্ড গবেষণা ও কনটেন্ট অপ্টিমাইজেশন",
        "টেকনিক্যাল এসইও অডিট ও বাস্তবায়ন",
        "নিয়মিত রিপোর্ট ও পারফরম্যান্স বিশ্লেষণ",
      ],
    },
    approach: {
      title: "আমাদের এসইও দৃষ্টিভঙ্গি",
      items: [
        {
          title: "গবেষণা ও বিশ্লেষণ",
          body:
            "কার্যকর এসইও কৌশল সাজাতে আমরা আপনার খাত, প্রতিযোগী আর লক্ষ্য দর্শক নিয়ে গভীর গবেষণা করি।",
        },
        {
          title: "অন-পেজ অপ্টিমাইজেশন",
          body:
            "লক্ষ্য কি-ওয়ার্ডে প্রাসঙ্গিকতা ও দৃশ্যমানতা বাড়াতে আমরা আপনার সাইটের কনটেন্ট, মেটা ট্যাগ আর কাঠামো সাজিয়ে নিই।",
        },
        {
          title: "কনটেন্ট কৌশল",
          body:
            "আমরা এমন কনটেন্ট কৌশল সাজাই যা আপনার দর্শকের প্রয়োজন মেটায় আর আপনার ব্র্যান্ডকে খাতের নির্ভরযোগ্য নাম হিসেবে প্রতিষ্ঠা করে।",
        },
        {
          title: "পর্যবেক্ষণ ও রিপোর্ট",
          body:
            "আমরা নিয়মিত আপনার এসইও পারফরম্যান্স দেখি আর কাজে লাগানোর মতো পরামর্শসহ নিয়মিত রিপোর্ট দিই।",
        },
      ],
    },
    benefits: {
      title: "আমাদের এসইও সেবার সুবিধা",
      items: [
        {
          title: "বেশি অর্গানিক ট্রাফিক",
          body:
            "আমাদের এসইও কৌশল সার্চ ফলাফলে আপনার দৃশ্যমানতা বাড়ায়, ফলে ওয়েবসাইটে আরও বেশি অর্গানিক ট্রাফিক আসে।",
        },
        {
          title: "আরও মানসম্মত লিড",
          body:
            "সঠিক কি-ওয়ার্ড ধরে আর কনটেন্ট সাজিয়ে আমরা এমন দর্শক আনি, যাঁদের ক্রেতা হওয়ার সম্ভাবনা বেশি।",
        },
        {
          title: "উন্নত ব্যবহারকারী অভিজ্ঞতা",
          body:
            "আমাদের এসইও সেবায় সাইটের কাঠামো আর কনটেন্ট এমনভাবে সাজানো হয় যাতে দর্শকের অভিজ্ঞতা আরও ভালো হয়।",
        },
        {
          title: "দীর্ঘমেয়াদি ফল",
          body:
            "পেইড বিজ্ঞাপনের মতো নয় — এসইও এমন টেকসই ফল দেয় যা সময়ের সাথে আপনার ব্যবসার উপকার করতেই থাকে।",
        },
      ],
    },
    caseStudy: {
      label: "কেস স্টাডি",
      imageAlt: "এসইও কেস স্টাডি",
      title: "একটি বি২বি সফটওয়্যার প্রতিষ্ঠানের অর্গানিক ট্রাফিক আমরা যেভাবে ১৫০% বাড়িয়েছি",
      body:
        "একটি বি২বি সফটওয়্যার প্রতিষ্ঠান আমাদের কাছে এসেছিল, কারণ তাদের ওয়েবসাইট থেকে লিড আসছিল না। আমাদের পূর্ণাঙ্গ এসইও কৌশলে আমরা পেরেছি:",
      results: [
        "৬ মাসে অর্গানিক ট্রাফিক ১৫০% বাড়াতে",
        "৫০-এর বেশি গুরুত্বপূর্ণ কি-ওয়ার্ডে র‍্যাংকিং উন্নত করতে",
        "ওয়েবসাইট থেকে ৪০% বেশি যোগ্য লিড আনতে",
      ],
      readFull: "পুরো কেস স্টাডি পড়ুন",
    },
    packages: {
      title: "এসইও সেবার প্যাকেজ",
      popular: "জনপ্রিয়",
      perMonth: "/মাস",
      ...
      tiers: [
        {
          name: "বেসিক",
          audience: "যেসব ছোট ব্যবসা সবে এসইও শুরু করছে",
          price: "$1,500",
          features: [
            "কি-ওয়ার্ড গবেষণা (২০টি পর্যন্ত)",
            "অন-পেজ অপ্টিমাইজেশন (১০টি পেজ পর্যন্ত)",
            "মাসিক পারফরম্যান্স রিপোর্ট",
            "প্রাথমিক টেকনিক্যাল এসইও অডিট",
          ],
        },
        {
          name: "প্রফেশনাল",
          audience: "যেসব বাড়ন্ত ব্যবসার পূর্ণাঙ্গ এসইও দরকার",
          price: "$3,000",
          features: [
            "কি-ওয়ার্ড গবেষণা (৫০টি পর্যন্ত)",
            "অন-পেজ অপ্টিমাইজেশন (২৫টি পেজ পর্যন্ত)",
            "কনটেন্ট তৈরি (মাসে ২টি ব্লগ পোস্ট)",
            "পূর্ণাঙ্গ টেকনিক্যাল এসইও অডিট",
            "প্রতিযোগী বিশ্লেষণ",
            "পাক্ষিক পারফরম্যান্স রিপোর্ট",
          ],
        },
        {
          name: "এন্টারপ্রাইজ",
          audience: "যেসব বড় প্রতিষ্ঠানের জটিল এসইও চাহিদা আছে",
          price: "$5,000+",
          features: [
            "পূর্ণাঙ্গ কি-ওয়ার্ড গবেষণা",
            "পুরো ওয়েবসাইট অপ্টিমাইজেশন",
            "কনটেন্ট তৈরি (মাসে ৪+ ব্লগ পোস্ট)",
            "উন্নত টেকনিক্যাল এসইও বাস্তবায়ন",
            "গভীর প্রতিযোগী বিশ্লেষণ",
            "সাপ্তাহিক পারফরম্যান্স রিপোর্ট",
            "নিবেদিত এসইও ম্যানেজার",
          ],
        },
      ],
    },
    faq: {
      ...
      items: [
        {
          question: "এসইওর ফল পেতে কত সময় লাগে?",
          answer:
            "এসইও একটি দীর্ঘমেয়াদি কৌশল। কিছু উন্নতি কয়েক সপ্তাহেই চোখে পড়ে, তবে বড় ফল সাধারণত ৩-৬ মাস লাগে। সময়টা নির্ভর করে আপনার সাইটের বর্তমান অবস্থা, প্রতিযোগিতা আর কৌশলের ব্যাপ্তির উপর।",
        },
        {
          question: "আপনাদের এসইও সেবা আলাদা কেন?",
          answer:
            "আমরা এসইওতে ডেটাভিত্তিক ও স্বচ্ছ পদ্ধতি অনুসরণ করি। মাপযোগ্য ফল দেওয়া আর পরিষ্কার রিপোর্ট দেওয়ায় আমাদের মনোযোগ, যাতে আমাদের কাজের প্রভাব আপনি নিজেই দেখতে পান। আমাদের কৌশল আপনার নির্দিষ্ট লক্ষ্য আর দর্শকের জন্য সাজানো।",
        },
        {
          question: "প্রথম পাতায় র‍্যাংকিংয়ের নিশ্চয়তা দেন?",
          answer:
            "সার্চ অ্যালগরিদম নিয়ত বদলায় বলে কোনো নির্ভরযোগ্য এসইও এজেন্সিই নির্দিষ্ট র‍্যাংকিংয়ের নিশ্চয়তা দিতে পারে না। আমরা পরীক্ষিত কৌশল কাজে লাগাই যা আপনার দৃশ্যমানতা বাড়ায় আর যোগ্য ট্রাফিক আনে, তবে যা রাখতে পারব না তার প্রতিশ্রুতি দিই না।",
        },
        {
          question: "শুরু করতে আমাকে কী দিতে হবে?",
          answer:
            "শুরু করতে আমাদের আপনার ওয়েবসাইট অ্যানালিটিক্স, সার্চ কনসোল আর সিএমএস-এ প্রবেশাধিকার লাগবে। এছাড়া আপনার ব্যবসায়িক লক্ষ্য, দর্শক আর বর্তমান মার্কেটিং কার্যক্রম বুঝতে আমরা একটি প্রাথমিক আলোচনা করব।",
        },
      ],
    },
    cta: {
      title: "সার্চ র‍্যাংকিং বাড়াতে প্রস্তুত?",
      body: "আমাদের এসইও সেবা কীভাবে আপনার ব্যবসাকে এগিয়ে নিতে পারে, তা জানতে আজই যোগাযোগ করুন।",
      button: "বিনামূল্যে এসইও পরামর্শ নিন",
    },
  },
});
