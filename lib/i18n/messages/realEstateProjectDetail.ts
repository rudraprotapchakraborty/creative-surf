...
export const realEstateProjectDetailMessages = defineMessages({
  ...
  bn: {
    ...
    location: {
      title: "অবস্থান",
      overviewNote: "— ঢাকার সার্বিক চিত্র",
      viewOnMaps: "Google Maps-এ দেখুন",
      mapTitleFallback: "ঢাকা, বাংলাদেশ",
      mapTitle: "{name}-এর অবস্থান",
      tapToOpen: "Google Maps-এ খুলতে ট্যাপ করুন",
      openInMaps: "Maps-এ খুলুন →",
    },
    ...
    gallery: "গ্যালারি",
    blogs: {
      eyebrow: "রিয়েল এস্টেট বিশ্লেষণ",
      title: "সাম্প্রতিক লেখা ও পরামর্শ",
