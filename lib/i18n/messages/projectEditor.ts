...
export const projectEditorMessages = defineMessages({
  ...
  bn: {
    ...
    subtitleLabel: "উপশিরোনাম / সোসাইটি",
    subtitlePlaceholder: "যেমন JOLSHIRI ABASHON",
    plotDetailsLabel: "প্লটের বিবরণ",
    specs: {
      plotNo: "প্লট নম্বর",
      roadNo: "রোড নম্বর",
      sector: "সেক্টর",
      plotSize: "প্লটের আয়তন",
      numberOfUnits: "ইউনিট সংখ্যা",
      buildingDetails: "ভবনের বিবরণ",
      flatSize: "ফ্ল্যাটের আয়তন",
    },
    featuresDescriptionLabel: "সুবিধার বিবরণ",
    featuresDescriptionPlaceholder: "প্রকল্পের প্রধান সুবিধাগুলো লিখুন…",
    rooftopFeatures: "ছাদের সুবিধা",
    groundFloorFeatures: "নিচতলার সুবিধা",
    availableFlats: "খালি ফ্ল্যাট",
    featurePlaceholder: "সুবিধা লিখে Enter চাপুন…",
    statusLabel: "অবস্থা",
    coverImageLabel: "কভার ছবি",
    additionalImages: "আরও ছবি",
    mapLabel: "Google Map অবস্থান",
    mapPlaceholder: "Google Maps-এর embed URL বা শেয়ার লিংক দিন…",
    mapHintStart: "Google Maps-এর",
    mapHintStrong: "embed URL",
    mapHintEnd: "দিন (Share → Embed a map → src URL কপি করুন) অথবা সাধারণ একটি Google Maps লিংক দিন।",
    saving: "সংরক্ষণ হচ্ছে…",
    updateProject: "প্রকল্প হালনাগাদ করুন",
    addProject: "প্রকল্প যোগ করুন",
    errors: {
      nameRequired: "প্রকল্পের নাম আবশ্যক।",
      loadFailed: "প্রকল্পটি লোড করা যায়নি।",
